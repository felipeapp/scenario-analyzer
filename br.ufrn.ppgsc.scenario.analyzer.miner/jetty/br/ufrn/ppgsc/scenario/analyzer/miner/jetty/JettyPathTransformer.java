...
public class JettyPathTransformer implements IPathTransformer {
	...
	public String[] convert(String method_signature, String repository_prefix, String workcopy_prefix_v1, String workcopy_prefix_v2) {
		...
		/*
		 * TODO: Fazer isso com uma consulta no banco depois Testa se é um
		 * método (inicia com caractere não maiúsculo) Isso precisa ser
		 * melhorado com um booleano nas próximas versões
		 */
		...
		else if (name.endsWith("Tester") && name.contains("http"))
			full_path += "jetty-http/src/test/java/";
