...
public class UTest {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 0; i < hibernate_cfgs.length - 1; i++) {
			...
			Map<String, SimpleStatElement> stats_v1 = dao_v1.getSimpleStatOfScenarios();
			System.out.println("\tTotal = " + stats_v1.size());

			System.out.println("Collecting averages from release 2...");
			Map<String, SimpleStatElement> stats_v2 = dao_v2.getSimpleStatOfScenarios();
			System.out.println("\tTotal = " + stats_v2.size());

			System.out.println("Intersection...");
			Set<String> signatures_commons = AnalyzerCollectionUtil.intersect(stats_v1.keySet(), stats_v2.keySet());
			...
			for (String s : signatures_commons) {
				...
				double[] execution_time_v1 = stats_v1.get(s).getTimeMeasurements();
				double[] execution_time_v2 = stats_v2.get(s).getTimeMeasurements();
				...
				double avg_v1 = stats_v1.get(s).getAverage();
				double avg_v2 = stats_v2.get(s).getAverage();
