...
public class PathTransformerSIGAA implements IPathTransformer {
	...
	public String[] convert(String method_signature) {
		...
		return new String[] {full_path,
				"/home/felipe/Doutorado/workspaces/workspace-sigaa-3.11.24-checkout/" + full_path,
				"/home/felipe/Doutorado/workspaces/workspace-sigaa-3.12.18-checkout/" + full_path};
	}
