package br.ufrn.dimap.ttracker.tests;
...
public class TestFactory {
	...
	private final String testPackage = "br.ufrn.dimap.ttracker.tests";
	...
	private String initializeStartContet(){
		...
		stringBuffer.append("import br.ufrn.dimap.ttracker.data.TestCoverageMapping;"+"\n\n");
