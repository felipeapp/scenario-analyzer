...
public class TestTrackerSVNDiffGenerator implements ISVNDiffGenerator {
     ...
     *
     */
    public TestTrackerSVNDiffGenerator() {
        myAnchorPath1 = "";
        myAnchorPath2 = "";
        setDiffDeleted(true);
        setDiffAdded(true);
...
//            bos.write(PROPERTIES_SEPARATOR.getBytes(getEncoding()));
    ...
    public void displayFileDiff(String path, File file1, File file2,
        ...
        try {
            ...
            TestTrackerDiffUniGenerator.setup();
            @SuppressWarnings("unchecked")
			Map<Object,Object> properties = new SVNHashMap();
...
//				content = content.substring(0, content.length()-"\r\n".length());
    ...
    protected void displayHeader(OutputStream os, String path, File file1, File file2, String rev1, String rev2) throws IOException {
    	os.write("    <br.ufrn.dimap.rtquality.history.ClassUpdates>".getBytes(getEncoding()));
    	os.write(getEOL());
    ...
    private void displayMergeInfoDiff(ByteArrayOutputStream baos, String oldValue, String newValue) throws SVNException, IOException {
        ...
        Map<Object,Object> deleted = new TreeMap<Object,Object>();
        Map<Object,Object> added = new TreeMap<Object,Object>();
