var PainelNoticias = (function() {
	var painel, link, urlRedirect;
	
	return {
		init : function(urlParametro) {
			
			urlRedirect = urlParametro;
			link = getEl('noticias-portal');
			if (link != undefined)
        ...
        show : function(event){
			...
			// tem o substring por que o id do componente é noticia_ID
			mgr.update(urlRedirect + '?id=' + el.id.substring(8) + '&ajaxRequest=true');
