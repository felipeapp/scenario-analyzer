...
//	private IdentificadorNavegador identNavegador;
//	private IdentificadorSistemaOperacional identSo;
	
	private SincronizadorRegistroEntrada(DataSource ds) {
		if (ds != null) {
			jtSistema = new JdbcTemplate(ds);
			
//			identNavegador = new IdentificadorNavegador();
//			identNavegador.setNavegadores(new NavegadorDAO().findAll());
//			identSo = new IdentificadorSistemaOperacional();
//			identSo.setSistemasOperacionais(new SistemaOperacionalDAO().findAll());
		}
	}
