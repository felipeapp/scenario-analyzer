...
import fundacao.integracao.projetos.orcamento.OrcamentoRubricaDTO;
...
public class ProjetoDTO implements Serializable {
	...
	/* Dados gerais: */
	/** 1=Público 2=Privado 3=Público/Privado*/
	...
	/** Representa o identificador da grande área do projeto.*/
	private Integer idGrandeArea;

	/** Representa a grande área do projeto.*/
	...
	/** Representa o identificador da especialidade do projeto.*/
	private Integer idEspecialidade;

	/** Representa a especialidade do projeto.*/
	...
	private List<OrcamentoRubricaDTO> planosAplicacao;
	...
	public void setPlanosAplicacao(List<OrcamentoRubricaDTO> planosAplicacao) {
		this.planosAplicacao = planosAplicacao;
	}

	public List<OrcamentoRubricaDTO> getPlanosAplicacao() {
	...
	public void setIdGrandeArea(Integer idGrandeArea) {
		this.idGrandeArea = idGrandeArea;
	}

	public Integer getIdGrandeArea() {
		return idGrandeArea;
	}
