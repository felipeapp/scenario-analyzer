...
/**
 *  <p>Na suspensão de um período de inscrição para uma atividade.</p>
 *    
 *  <p> TODOS Os particpantes não aprovados da atividade e das sub atividades serão cancelados. Um email de aviso deve ser enviado. </p>
 * 
 * @author jadson
 *
 */
public class ProcessadorSuspendePeriodoInscricaoAtividade extends AbstractProcessador{
