...
<%@page import="br.ufrn.arq.seguranca.SigaaPapeis"%>
    ...
    <ul>
   		<li> Turma
			...
			<%--<li><h:commandLink action="#{ buscaTurmaBean.popularBuscaGeral }" value="Consultar, Alterar ou Remover" onclick="setAba('turma')"/> </li>--%>
				<li><a href="${ctx}/ensino/consolidacao/selecionaTurma.jsf?gestor=true&aba=turma">Consolidar Turma</a></li>
				<li><h:commandLink action="#{buscaTurmaBean.popularBuscaTecnico}" value="Consulta Geral de Turmas" onclick="setAba('turma')"></h:commandLink></li>
   			</ul>
   		</li>
   		<li> Docentes Externos
   			<ul>
	   			<li><h:commandLink action="#{docenteExterno.popular}" value="Cadastrar"  onclick="setAba('turma')"/></li>
	   			<li><a href="${ctx}/administracao/docente_externo/lista.jsf?aba=turma">Listar/Alterar</a></li>
   			</ul>
   		</li>
