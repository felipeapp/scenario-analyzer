...
<h2> <ufrn:subSistema /> &gt; Solicitação de Cota &gt; Escolha do Projeto </h2>
...
<div class="descricaoOperacao">
	<p>
		Agora selecione o projeto ao qual deseja vincular o plano de trabalho que será cadastrado.
		...
		<ul>
			...
			<li> Possui período de execução que comporte o período de cota do edital selecionado no passo anterior </li>
		</ul>
	</p>
</div>
