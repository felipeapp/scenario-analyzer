...
<table class="listagem">
	<caption>Relatórios Finais dos Planos de Trabalho em Andamento</caption>
	<thead>
		<tr>
			<th> Discente </th>
	...
	<tbody>
		...
		<tr class="${status.index % 2 == 0 ? "linhaPar" : "linhaImpar"}">
			...
			<td>
				<ufrn:link action="/pesquisa/relatorioBolsaFinal" param="idRelatorio=${_relatorio.id}&dispatch=view">
					<img src="${ctx}/img/pesquisa/view.gif" />
				</ufrn:link>
				<ufrn:link action="/pesquisa/relatorioBolsaFinal" param="idRelatorio=${_relatorio.id}&dispatch=selecionarBolsista">
