...
<f:view>
	...
	de cursos. Digite o número de vagas correspondente ao cursos, por
	período de entrada, e clique em atualizar.</div>
		...
		<center><h:panelGroup id="table">
			<t:dataTable value="#{cadastroOfertaVagasCurso.listaOfertaVagasCurso}"
				...
				<h:column headerClass="right">
					<f:facet name="header">
						<h:outputText value="1º Período" style="text-align: center;" />
					</f:facet>
