...
<h2>Lista de Alunos ativos e seus prazos de conclusão</h2>
...
<table align="center" class="formulario" width="100%">
	...
	<tr>
		<th>Curso: </th>
		<td>
			<h:inputHidden id="id" value="#{relatorioDiscente.curso.id}"/>
			<h:inputText id="nome" value="#{relatorioDiscente.curso.nome}" size="80" />
			<ajax:autocomplete source="form:nome" target="form:id"
	...
	<tr>
		<td colspan="2" align="center">
			...
			action="#{relatorioDiscente.gerarRelatorioListaAlunoPrazoConclusao}"/>
