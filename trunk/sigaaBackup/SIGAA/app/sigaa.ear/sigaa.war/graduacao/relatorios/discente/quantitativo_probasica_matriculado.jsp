...
<f:view>
	<hr>
	<table width="100%">
		<caption><b>Quantitativos de Alunos de Probásica Matriculados</b></caption>
			<tr>
				<th>Centro:</th>
				<td><b><h:outputText
	...
	<c:forEach items="${relatorioDiscente.listaDiscente}" var="linha" varStatus="row">
		...
		<c:if test="${curso != cursoAtual || grauAcademico != grauAcademicoAtual || habilitacao != habilitacaoAtual}">
		 ...
		 <c:set var="totalHomensGrupo" value="${totalHomensGrupo + linha.qtd_matriculados}"/>
		 <c:set var="totalHomens" value="${totalHomens + linha.qtd_matriculados}"/>
		<tr>
