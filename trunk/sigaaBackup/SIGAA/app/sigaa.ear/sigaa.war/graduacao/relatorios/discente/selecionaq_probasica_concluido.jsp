...
<h2><ufrn:subSistema /> > Quantitativos de Alunos de Probásica concluídos</h2>
...
<table align="center" class="formulario" width="100%">
	...
	<tr>
		...
		<td>
		<h:inputHidden id="id" value="#{relatorioDiscente.centro.id}"></h:inputHidden>
				<h:inputText id="nome"
	...
	<tr>
		<td colspan="2" align="center">
						<h:commandButton id="gerarRelatorio" value="Gerar Relatório" action="#{relatorioDiscente.gerarRelatorioQuantitativoAlunoProbasicaConcluido}">
