...
<f:view>
	...
	<table width="100%">
		<caption><b>Relatório de alunos por cidade de residência</b></caption>
			<tr>
				<th>Centro:</th>
				<td><b><h:outputText
					value="#{relatorioHabilitacao.centro.nome }" /></b></td>
				<th>Curso:</th>
				<td><b><h:outputText
					value="#{relatorioHabilitacao.curso.descricao }" /></b></td>
			</tr>
	</table>
	<hr>
	<table>
	...
	<c:forEach items="${relatorioHabilitacao.listaDiscente}" var="linha">
		<tr>
			<td>
