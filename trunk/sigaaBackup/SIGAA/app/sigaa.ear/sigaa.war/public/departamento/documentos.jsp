	...
	<div id="colDir">
		...
		<h1 class="documento"><h:outputText value="#{idioma.documentos}" /> </h1>
			<div id="documentos">
				<c:if test="${not empty portalPublicoDepartamento.documentos}">
					<div class="legenda">
					...
					<table class="listagem">
						...
						<tbody>
							<c:forEach items="#{portalPublicoDepartamento.documentos}" var="doc" 
							varStatus="status">
						...
						<tfoot>
							<tr>
								<td colspan="2"><b>${fn:length(portalPublicoDepartamento.documentos)}</b> 
				...
				<c:if test="${empty portalPublicoDepartamento.documentos}">
