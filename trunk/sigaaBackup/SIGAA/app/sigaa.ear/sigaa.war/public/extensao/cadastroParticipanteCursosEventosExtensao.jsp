...
<f:view>
	...
	<div class="descricaoOperacao">
		<p>Cadastre-se para poder se inscrever em algum dos cursos ou eventos de extensão oferecidos.</p>
		<br/>
		<p><strong>Observação:</strong> Para que o cadastro seja efetivado é preciso confirmá-lo por meio de um e-mail 
		que será enviado para o endereço informado.
		</p>
	</div>
	...
	<h:form id="formCadastroParticipantes" enctype="multipart/form-data">
		...
		<caption>Formulário de Cadastro</caption>
			...
			<tbody>
				...
				<tr>	
					<th style="width:20%;">Estrangeiro: </th>
					<td colspan="3">
			...
			<tfoot>
				<tr>
					<td colspan="4">
						<h:commandButton id="cmdButtonCadastrar" value="Cadastrar" action="#{cadastroParticipanteAtividadeExtensaoMBean.cadastrarNovoParticipante}" 
								onclick="return confirm('Confirma seu cadastro no sistema ? ');" />
