...
<h2>
	...
	Cadastro de Exposição ou Apresentacão Artisticas
</h2>

   <h:form>
	 <div class="infoAltRem" style="width: 100%">
	  <h:graphicImage value="/img/listar.gif"style="overflow: visible;"/>
	  <a href="${ctx}/prodocente/producao/ExposicaoApresentacao/lista.jsf" >Listar Exposição ou Apresentacão Artística Cadastrados</a>
	 </div>
    </h:form>
...
<!-- xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx -->
	...
	<caption class="listagem">Cadastro de Exposição ou Apresentacão Artística</caption>
