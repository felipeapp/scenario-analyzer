...
<f:view>
	...
	<div class="infoAltRem">
		<h:graphicImage value="/img/adicionar.gif"style="overflow: visible;"/><h:commandLink action="#{capitulo.preCadastrar}" value="Cadastrar Capítulos de Livros" /><h:graphicImage value="/img/alterar.gif"style="overflow: visible;"/>: Alterar Capítulo
	    <h:graphicImage value="/img/delete.gif" style="overflow: visible;"/>: Remover Capítulo
...
<c:if test="${empty lista}">
	<br />
	<center>
	<span style="color:red;">Nenhum Capítulo de Livro Encontrado.</span>
	</center>
</c:if>
<c:if test="${not empty lista}">
	...
	<table class="listagem" style="width:100%" border="1">
		<caption class="listagem">Lista de Capítulos de Livros</caption>
		<thead>
			<td></td>
			<td>Título</td>
			<td>${item.anoReferencia}</td>
			<td style="text-align: left;">Título do Livro</td>
