...
<f:view>
	...
	<div class="infoAltRem">
		 <h:graphicImage value="/img/adicionar.gif"style="overflow: visible;"/><h:commandLink action="#{banca.formCadastrarConcurso}" value="Cadastrar Nova Comissão Julgadora"/><h:graphicImage value="/img/alterar.gif"style="overflow: visible;"/>: Alterar
...
<c:if test="${empty lista}">
	<br />
	<center>
	<span style="color:red;">Nenhuma Comissão Julgadora Encontrada.</span>
	</center>
</c:if>
<c:if test="${not empty lista}">
	...
	<table class=listagem style="width:100%" border="1">
		<caption class="listagem">Lista de Comissões Julgadoras</caption>
		<thead>
