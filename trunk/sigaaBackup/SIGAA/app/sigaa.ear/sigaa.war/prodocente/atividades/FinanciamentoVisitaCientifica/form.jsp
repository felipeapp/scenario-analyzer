...
<f:view>
	...
	<h:form>
		...
		<h:commandLink action="#{financiamentoVisitaCientifica.listar}"
			value="ListarColegiados Cadastrados"/>
		</div>
	</h:form>
	...
	<h:form id="form">
		<table class=formulario width="95%">
			...
			<tr>
				...
				<td><h:inputHidden id="id" value="#{financiamentoVisitaCientifica.obj.servidor.id}"></h:inputHidden>
				<h:inputText id="nomeServidor"
					value="#{financiamentoVisitaCientifica.obj.servidor.pessoa.nome}" size="60" /> <ajax:autocomplete
