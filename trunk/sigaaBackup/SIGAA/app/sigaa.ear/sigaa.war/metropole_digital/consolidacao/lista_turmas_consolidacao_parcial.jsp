...
<h2>
	<ufrn:subSistema />
	> Consolidação Parcial > Lista de Turmas
</h2>
...
<f:view>
	...
	<h:form>
		...
		<table class="formulario" style="width: 100%">
			...
			<c:forEach items="#{consolidacaoParcialIMD.listaTurmasConsolidacao}"
				...
				<tr class="${i.count%2==0? 'linhaPar': 'linhaImpar' }"
					...
					<td align="right"><h:commandLink action="#{consolidacaoParcialIMD.relatorioConsolidacaoParcial}">
