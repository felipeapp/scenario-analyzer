	...
	<tr>
		<td>
			<table class="subFormulario" width="100%">
				...
				<tr>
					<th width="20%" class="obrigatorio"> Título do Projeto: </th>
					<td>
				...
				<tr>
	                <th class="required"> Configuração do Projeto Externo: </th>
	                <td>
                      <a4j:region> 
	                        ...
	                        <h:selectOneMenu id="edital" value="#{projetoMonitoria.obj.editalMonitoria.id}" rendered="#{projetoMonitoria.editalDesteProjetoAindaAberto}">
	                            ...
	                            <f:selectItems value="#{projetoMonitoria.configuracaoProjetoExternoCombo}"/>
				...
				<tr>
					...
					<td>
						<h:inputText id="anoReferencia" value="#{projetoMonitoria.obj.ano}" maxlength="4" size="4" onkeyup="formatarInteiro(this)"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<t:inputCalendar  popupDateFormat="dd/MM/yyyy" 
							id="dataInicio" value="#{projetoMonitoria.obj.projeto.dataInicio}" 
							renderAsPopup="true"  renderPopupButtonAsImage="true"
							popupTodayString="Período Inicial" title="Data Inicio"
							size="10" onkeypress="return(formataData(this,event))"  maxlength="10"/>
						à
						<t:inputCalendar  popupDateFormat="dd/MM/yyyy" 
							id="dataFim" value="#{projetoMonitoria.obj.projeto.dataFim}" 
							renderAsPopup="true"  renderPopupButtonAsImage="true"
							popupTodayString="Período Inicial" title="Data Fim"
							size="10" onkeypress="return(formataData(this,event))"  maxlength="10"/>
					</td>						
				</tr>
