		...
		<tfoot>
			<tr>
				<td colspan="2">
					...
					<%-- Avaliação da comissão de monitoria --%>
					<h:commandButton value="Confirmar Avaliação"action="#{avalProjetoMonitoria.confirmarAvaliacao}" rendered="#{!avalProjetoMonitoria.obj.avaliacaoPrograd}"/>
					
					<%-- Avaliação por discrepância de notas --%>
					<h:commandButton value="Confirmar Avaliação"action="#{avalProjetoMonitoria.confirmarAvaliacaoDiscrepancia}" rendered="#{avalProjetoMonitoria.obj.avaliacaoPrograd}"/>
