...
<f:view>
	...
	<h2><ufrn:subSistema /> > Solicitações de Reconsiderações do Projeto Selecionado</h2>
			...
			<table class="listagem">
			    <caption>Lista de Reconsiderações Solicitadas</caption>
				...
				<c:set var="lista" value="#{solicitacaoReconsideracao.obj.projetoMonitoria.projeto.solicitacoesReconsideracao}" />

				<c:if test="${empty lista}">
			        <tbody>
	                    <tr> <td colspan="5" align="center"> <font color="red">Não há solicitações de reconsideração cadastradas para este projeto </font> </td></tr>
					</tbody>
				</c:if>
