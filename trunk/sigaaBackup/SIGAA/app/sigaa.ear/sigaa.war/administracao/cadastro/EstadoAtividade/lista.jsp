...
<f:view>
	...
	<h:outputText value="#{estadoAtividade.create}" />
	...
	<center>
			...
			<div class="infoAltRem">
				<h:form>
					...
					<h:commandLink action="#{estadoAtividade.preCadastrar}" value="Cadastrar"/>
