			...
			<tbody>
				...
				<tr>
					...
					<td><h:inputText value="#{parametros.obj.horasCreditosAula}" size="3" 
						...
						<ufrn:help>Valor de hora/aula equivalente a 1 unidade de crédito.</ufrn:help>
					</td>
				</tr>
				<tr>
					...
					<td><h:inputText value="#{parametros.obj.horasCreditosLaboratorio}" size="3" 
						...
						<ufrn:help>Valor de hora/aula de laboratório equivalente a 1 unidade de crédito.</ufrn:help>
					</td>
				</tr>
				<tr>
					...
					<td><h:inputText value="#{parametros.obj.horasCreditosEstagio}" size="3" 
						...
						<ufrn:help>Valor de hora/aula de estágio equivalente a 1 unidade de crédito.</ufrn:help>
					</td>
				</tr>
				<tr><td colspan="2" class="subFormulario">Cadastro de Turmas</td></tr>
				<tr>
					<th>Verificar Choque de Horários em Cadastro de Turmas e Disciplinas:</th>
				...
				<tr>
					<th class="obrigatorio">Número Máximo de Avaliações por Disciplina:</th>
