...
<f:view>
	...
	<h:form id="form">
		...
		<caption class="listagem">Validação de Relatório de Ações Acadêmicas Associadas</caption>	
			...
			<tr>
				<td colspan="2"><b> Ajustes Realizados Durante a Execução da Ação Acadêmica Associada:</b><br/>
			...
			<tr>
					...
					<td>	
						<h:selectOneMenu id="tipoParecerDepartamento" value="#{validacaoRelatorioBean.relatorio.tipoParecerDepartamento.id}"
			...
			<tr>			
					<th id="justificativa">Justificativa: </th>
					<td>
						<h:inputTextarea  id="parecerDepartamento" value="#{validacaoRelatorioBean.relatorio.parecerDepartamento}" rows="5" style="width: 95%"/>
					</td>
			</tr>
			...
			<tfoot>
				<tr>
					<td colspan="2">
						<h:commandButton id="confirmar" value="Confirmar Validação" action="#{validacaoRelatorioBean.validarPorDepartamento}" /> 
