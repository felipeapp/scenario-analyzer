...
<div class="descricaoOperacao">
	<table width="100%">
		<tr>
			<td width="50%">
			Nesta tela devem ser anexados os arquivos de uma Ação.
			</td>
			<td>
...
<table width="100%" id="aviso">
	<tr>
		...
		<b><font color="black" size="2">Atenção:</font></b>
			Utilize este espaço para enviar o arquivo completo da Proposta da Ação
			de Extensão caso tenha sido elaborada também em outro formato (Word, Excel, PDF e outros).<br/>
	...
	<tfoot>
		<tr> 
			<td colspan=2>
				...
				<h:commandButton value="Avançar >> " action="#{atividadeExtensao.submeterArquivos}" />
			</td> 
		</tr>
	</tfoot>
