...
<f:view>
	...
	<%@include file="/extensao/barra_filtro_atividade.jsp"%>
		...
		<div class="infoAltRem">
		    <h:graphicImage value="/img/seta.gif"style="overflow: visible;" rendered="#{acesso.extensao}"/><h:outputText rendered="#{acesso.extensao}" value=": Distribuir Esta Ação"/>
					...
					<td >
						...
						<t:dataTable id="listagem" value="#{filtroAtividades.resultadosBusca}" var="atividade" 
						  align="center" width="100%" styleClass="listagem tablesorter" rowClasses="linhaPar, linhaImpar">
							...
							<t:column width="2%">
									<h:commandLink title="Distribuir Esta Ação" action="#{ distribuicaoExtensao.selecionarAtividadeParecerista }" 
							...
							<t:column width="2%">
									<h:commandLink title="Distribuir Ações Vinculadas" action="#{ distribuicaoExtensao.distribuirAtividadesVinculadasParecerista }" 
