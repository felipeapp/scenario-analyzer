...
<h:form id="formPlanoTrabalho">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<textarea style="width:95%; height: 30px;" name="telaCronograma.atividade" tabindex="${statusAtividades.index}">${planoTrabalhoExtensao.telaCronograma.atividade[statusAtividades.index-1]}</textarea>
			</td>
	...
	<tfoot>
		<tr>
			<td colspan="${planoTrabalhoExtensao.telaCronograma.numeroMeses + 3}">
					<h:commandButton value="<< Voltar" action="#{planoTrabalhoExtensao.irDadosGerais}"  id="btVoltarDadosGerais"/>
					<h:commandButton value="Salvar (Rascunho)" action="#{planoTrabalhoExtensao.salvarCronograma}" id="btSalvar"/>
					<h:commandButton value="Cancelar" action="#{planoTrabalhoExtensao.cancelar}" onclick="#{confirm }" id="brCancelar"/>
					<h:commandButton value="Resumo >>" action="#{planoTrabalhoExtensao.submeterCronograma}"  id="btResumo"/> 
			</td>
		</tr>
	</tfoot>
...
<script type="text/javascript">
	var cronograma = new Cronograma('formPlanoTrabalho',
		'${planoTrabalhoExtensao.telaCronograma.mesesString}',
		'${numeroAtividades}'
	);
</script>
