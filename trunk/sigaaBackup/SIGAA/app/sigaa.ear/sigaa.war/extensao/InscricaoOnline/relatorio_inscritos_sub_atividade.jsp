...
<f:view>
	<h2>Relatório Quantitativo de Inscritos em Mini Atividades de Extensão pela Área Pública</h2>
	<div id="parametrosRelatorio">
		<table>
			<tr>
				<th>Código(Atividade Pai):</th>
				<td><h:outputText value="#{inscricaoAtividade.subAtividade.atividade.codigo}" id="codigo" /></td>
			</tr>
			<tr>
				<th>Título:</th>
				<td><h:outputText value="#{inscricaoAtividade.subAtividade.titulo}" id="titulo" /></td>
			</tr>
			<tr>
				<th>Coordenação:</th>
				<td><h:outputText value="#{inscricaoAtividade.subAtividade.atividade.coordenacao.servidor.pessoa.nome}" id="coord" /></td>
			</tr>
			<tr>
				<th>Período:</th>
				<td>
					<h:outputText value="#{inscricaoAtividade.subAtividade.inicio}" id="inicio"> 
						<f:convertDateTime pattern="dd/MM/yyyy"/>
					</h:outputText> 
					até 
					<h:outputText value="#{inscricaoAtividade.subAtividade.fim}" id="fim">
						<f:convertDateTime pattern="dd/MM/yyyy"/>
					</h:outputText> 
				</td>
			</tr>
