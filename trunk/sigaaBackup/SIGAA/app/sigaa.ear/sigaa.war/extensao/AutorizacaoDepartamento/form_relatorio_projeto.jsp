...
<f:view>
	...
	<h:form prependId="false">
		...
		<caption class="listagem">Validação de Relatório de Projetos</caption>	
		
			<tr>
				<th width="25%"><b> Código Projeto:</b></th>
				<td>
			...
			<tr>
				...
				<td>
					<h:outputText value="#{autorizacaoDepartamento.relatorio.atividade.publicoEstimado}" id="publicoEstimado"/> pessoas
				</td>	
			</tr>
			...
			<tr>
				...
				<td>
					<h:outputText value="#{autorizacaoDepartamento.relatorio.atividade.publicoAtendido}" id="publicoAtendido"/> pessoas
				</td>	
			</tr>
			...
			<tr>
				<td colspan="2"> <b>Relação entre a proposta pedagógica do curso e a proposta do projeto de extensão? Justifique:</b><br/>
					<h:outputText value="#{autorizacaoDepartamento.relatorio.relacaoPropostaCurso}" id="relacaoPropostaCurso"/>
				</td>	
			</tr>
			
			<tr>	
				<td colspan="2"><b>Outras ações realizadas vinculadas ao projeto:</b><br/>
					<t:dataList value="#{autorizacaoDepartamento.relatorio.outrasAcoesProjeto}" var="acao">
							<t:column>
			...
			<tr>	
				<td colspan="2"><b>Apresentação do projeto em eventos de extensão:</b><br/>
					<t:dataList value="#{ autorizacaoDepartamento.relatorio.apresentacaoProjetos }" var="apresentacao">
							<t:column>
			...
			<tr>	
				<td colspan="2"><b> Produção acadêmica gerada:</b><br/>
						<t:dataList value="#{ autorizacaoDepartamento.relatorio.producoesGeradas }" var="prod">
								<t:column>
				...
				<c:otherwise>
					<tr>
						<td colspan="2"><b> Atividades Realizadas: </b><br/>
							<h:outputText value="#{autorizacaoDepartamento.relatorio.atividadesRealizadas}" id="atividades"/>
						</td>	
					</tr>
			
					<tr>
						<td colspan="2"><b> Resultados Obtidos: Qualitativos.</b><br/>
							<h:outputText  value="#{autorizacaoDepartamento.relatorio.resultadosQualitativos}" id="qualitativos"/>
						</td>	
					</tr>
					...
					<tr>
						<td colspan="2"><b> Resultados Obtidos: Quantitativos.</b><br/>
							<h:outputText value="#{autorizacaoDepartamento.relatorio.resultadosQuantitativos}" id="quantitativos"/>
						</td>	
					</tr>
