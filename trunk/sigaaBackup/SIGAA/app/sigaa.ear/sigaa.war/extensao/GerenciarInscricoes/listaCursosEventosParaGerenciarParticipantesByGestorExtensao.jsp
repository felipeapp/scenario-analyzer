...
<f:view>
	...
	<h:form id="formListaCursosEventoParaGerenciarAparticipantes">
		...
		<div class="descricaoOperacao">
				...
				<p> Abaixo são apresentadas as atividades de extensão selecionadas. </p>
				...
				<p> Os participantes <strong>NÃO</strong> devem ser confundidos com os membros que fazem parte da equipe executora da ação. </p>
				<br/>
		...
		<table id="tabelaAtividades"  class="listagem" style="width: 100%;">
				...
				<tbody>
					<c:if test="${gerenciarParticipantesExtensaoByGestorExtensaoMBean.qtdCursosEventosParaGerenciarParticipantes > 0 }">
						<c:forEach items="#{gerenciarParticipantesExtensaoByGestorExtensaoMBean.cursosEventosParaGerenciarParticipantes}" var="cursoEvento" varStatus="count">
							<tr class="${count.index % 2 == 0 ? 'linhaPar' : 'linhaImpar'}" onMouseOver="javascript:this.style.backgroundColor='#C4D2EB'" onMouseOut="javascript:this.style.backgroundColor=''">
								...
								<td style="text-align: center;">
									<h:commandLink id="cmdLinkInscritosAtividade" title="Gerenciar Participantes" action="#{gerenciarParticipantesExtensaoByGestorExtensaoMBean.listarParticipantesAtividade}">
								...
								<td>	
									<h:commandLink action="#{gerenciarParticipantesExtensaoByGestorExtensaoMBean.listarParticipantesEmFormatoRelatorio}" style="border: 0;" 
								...
								<td>	
									<h:commandLink action="#{gerenciarParticipantesExtensaoByGestorExtensaoMBean.listarParticipantesEmFormatoListaPresenca}" style="border: 0;" 
								...
								<td>
									<h:commandLink action="#{gerenciarParticipantesExtensaoByGestorExtensaoMBean.preNotificarParticipantes}" style="border: 0;" 
								...
								<td>
									<h:commandLink action="#{gerenciarParticipantesExtensaoByGestorExtensaoMBean.listarInformacoesContatosParticipantesEmFormatoRelatorio}" style="border: 0;"
								...
								<td>
									<h:commandLink action="#{gerenciarParticipantesExtensaoByGestorExtensaoMBean.listarInformacoesContatosParticipantesEmFormatoPlanilha}" style="border 0;" title="Exportar informações de contato">
										<f:param name="idAtividadeSelecionada" value="#{cursoEvento.id}" />
							...
							<c:if test="${cursoEvento.qtdSubAtividadesExtensao > 0 }">
								<c:forEach items="#{cursoEvento.subAtividadesExtensao}" var="miniAtividade" varStatus="status">
									<tr class="${count.index % 2 == 0 ? 'linhaPar' : 'linhaImpar'}" onMouseOver="javascript:this.style.backgroundColor='#C4D2EB'" onMouseOut="javascript:this.style.backgroundColor=''">
										...
										<td style="text-align: center;">
											<h:commandLink 	id="cmdLinkInscritosMiniAtividade" title="Gerenciar Participantes" action="#{gerenciarParticipantesExtensaoByGestorExtensaoMBean.listarParticipantesAtividade}">
					...
					<c:if test="${gerenciarParticipantesExtensaoByGestorExtensaoMBean.qtdCursosEventosParaGerenciarParticipantes == 0 }">
						<tr>
							<td colspan="11" style="color: red; text-align: center;">A ação selecionada não é um cursos ou eventos de extensão </td>
						</tr>
					</c:if>
				</tbody>
