	...
	<table width="100%" class="tabelaTransparete" >
		...
		<tbody>
			...
			<tr>
				...
				<td colspan="2" style="padding-top: 5px"> ${detalhesAutoridadeMBean.obj.numeroDoSistema}</td>
			</tr>
	
	
			<%-- Os Campos de Controle do Titulo  --%>
	
			<c:forEach items="#{detalhesAutoridadeMBean.obj.camposControleOrdenadosByEtiqueta}"  var="campoControle" varStatus="loop">
					<tr>
			...
			<c:forEach items="#{detalhesAutoridadeMBean.obj.camposDadosOrdenadosByEtiqueta}"  var="campoDados" varStatus="loop">
