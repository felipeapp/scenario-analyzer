...
<style>
	...
	tr.componentes td {border-bottom: 0.2mm dashed black;}
</style>
<f:view>
	...
	<table width="100%" style="font-size: 11px;">
		<tr>
			<td align="center">
				<b>RELATÓRIO DOS PROGRAMAS QUE NÃO USARAM PROCESSO SELETIVO ON-LINE</b>
			</td>
		</tr>
	</table>
	<br />
	...
	<table cellspacing="1" width="100%" style="font-size: 11px;">
		<tr class="total">
			<td align="center">Total de programas que não usaram Processo Seletivo On-line: ${_total}</td>
		</tr>
	</table>
</f:view>
