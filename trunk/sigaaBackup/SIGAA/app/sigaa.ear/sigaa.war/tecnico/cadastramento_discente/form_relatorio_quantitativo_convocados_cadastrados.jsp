...
<h2><ufrn:subSistema /> &gt; Relatório Quantitativo de discentes Convocados X Cadastrados</h2>
...
<table class="formulario" width="80%">
	...
	<tr>
		...
		<td>
			<h:selectOneMenu id="selectPsVestibular" value="#{cadastramentoDiscenteTecnico.processoSeletivo.id}" valueChangeListener="#{cadastramentoDiscenteTecnico.changeProcessoSeletivo}">
	...
	<tr>
		...
		<td>
			<h:selectOneRadio id="formato" value="#{cadastramentoDiscenteTecnico.formatoRelatorio}">
				<f:selectItem itemValue="0" itemLabel="HTML" />
	...
	<tfoot>
		<tr>
			<td colspan="2">
				<h:commandButton id="btnBuscar" value="Buscar Discentes" action="#{cadastramentoDiscenteTecnico.gerarRelatorioQuantitativoConvocadosCadastrados}"/>
