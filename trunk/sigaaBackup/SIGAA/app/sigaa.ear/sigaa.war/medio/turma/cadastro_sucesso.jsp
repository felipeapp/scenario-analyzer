...
<div class="menu-botoes">
	<ul class="menu-interno">
		<li class="botao-grande mesmo-componente">
			<h:commandLink action="#{turmaMedio.preCadastrarMesmoComponente}">
 		...
 		<li class="botao-grande outro-componente">
			<h:commandLink action="#{turmaMedio.preCadastrarOutroComponente}">
		...
		<li class="botao-grande home">
			<h:commandLink action="#{turmaMedio.cancelar}">
