...
<tr class="${loop.index % 2 == 0 ? 'linhaPar' : 'linhaImpar' }">
	...
	<h:form prependId="false"> 
		...
		<h:commandLink action="#{consolidacaoIndividual.escolherTurma}" title="Selecionar Turma" id="turma">
...
<tr>
	<td colspan="2">
	<h:form id="botoes">
	<h:commandButton action="#{ consolidacaoIndividual.cancelar }" value="Cancelar" immediate="true" onclick="#{confirm}" id="cancelar"/>
	</h:form>
	</td>
</tr>
</tfoot>
