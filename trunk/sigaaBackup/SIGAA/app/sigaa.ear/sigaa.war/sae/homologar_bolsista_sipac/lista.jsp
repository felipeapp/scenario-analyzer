...
<h2><ufrn:subSistema /> &gt; Homologação de Bolsas no ${ configSistema['siglaSipac'] }</h2>
	...
	<table class="formulario" width="50%">
		...
		<tbody>
		    ...
		    <tr>					
		    	...
		    	<td>
		    		 <h:selectOneMenu id="municipio" value="#{ homologacaoBolsistaMBean.municipio.id }">
		    ...
		    <caption>Discentes Encontrados (${ fn:length(homologacaoBolsistaMBean.bolsas) })</caption>
		 	...
		 	<tbody>
	               ...
	               <tr class="${ status.index % 2 == 0 ? "linhaPar" : "linhaImpar" }">
	                   <td><h:selectBooleanCheckbox value="#{_bolsa.selecionado}" styleClass="check" rendered="#{ empty _bolsa.tipoBolsaSIPAC }"/></td> 
			...
			<tfoot>
					<tr>
						<td colspan="${homologacaoBolsistaMBean.obj.bolsaAuxilio.tipoBolsaAuxilio.id == 0 ? 9 : 8}">
							<center>
								<h:commandButton value="Homologar Cadastro de Bolsistas Selecionados" action="#{ homologacaoBolsistaMBean.homologarBolsas }"/>
