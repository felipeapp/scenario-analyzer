...
<f:view>
	...
	<caption>Buscar Discente com Bolsa Alimentação</caption>  
	<tbody>
		<tr>
	...
	<center>
		<div class="infoAltRem">
			<h:graphicImage width="16px" value="/img/add_user_card.ico" style="overflow: visible;"/>: Associar/Substituir Discente ao Cartão
		</div>
	</center>
	...
	<caption>Lista de Discentes Encontrados (${cartaoBeneficio.totalCartoesLocalizadas})</caption>
	 <tr>
  	...
  	<rich:dataTable id="dtCartoesEncontradas"  value="#{cartaoBeneficio.bolsas}" 
		...
		<rich:column >
			<h:commandLink title="Associar/Substituir Discente ao Cartão" action="#{ cartaoBeneficio.iniciarAssociarDiscente }" immediate="true" id="lnkAssociarSubst">
