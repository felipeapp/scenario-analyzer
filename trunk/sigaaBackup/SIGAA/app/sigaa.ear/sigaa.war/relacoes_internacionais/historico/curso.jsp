...
<h:form id="form_curso">

	<table class="formulario" width="80%">
		<caption>Internacionalização de Dados do Curso do Histórico</caption>
		<thead>
			<tr>
		...
		<tbody>		
			<tr><td colspan="2">
			<c:forEach items="#{historicoTraducaoMBean.mapaEntidade}" var="map" varStatus="loop">
		...
		<tr>
			<td colspan=2>
				<h:commandButton value="#{historicoTraducaoMBean.confirmButton}" action="#{historicoTraducaoMBean.cadastrar}" onclick="setAbaHistorico('curso')"/> 
