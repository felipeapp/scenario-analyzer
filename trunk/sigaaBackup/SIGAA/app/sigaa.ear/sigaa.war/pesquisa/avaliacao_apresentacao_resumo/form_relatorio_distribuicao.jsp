...
<f:view>
	...
	<h2><ufrn:subSistema /> &gt; Relatório de Distribuição de Avaliações de Apresentação de Resumo do CIC</h2>
	<h:form id="form">
		<table class="formulario" width="100%">
			...
			<tfoot>
				<tr>
				<td colspan="2">
					<h:commandButton value="Emitir Relatório" action="#{avaliacaoApresentacaoResumoBean.relatorioDistribuicao}" /> 
