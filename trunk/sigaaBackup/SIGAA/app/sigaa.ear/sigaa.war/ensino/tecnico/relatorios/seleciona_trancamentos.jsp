...
<h2> <ufrn:subSistema /> &gt; Lista de Trancamentos por Disciplina </h2>
	...
	<tfoot>
		<tr>
			<td colspan="2" align="center">
				<h:commandButton id="gerarRelatorio" value="Gerar Relatório" action="#{relatoriosTecnico.gerarRelatorioListaTrancamentoAluno}"/> 
