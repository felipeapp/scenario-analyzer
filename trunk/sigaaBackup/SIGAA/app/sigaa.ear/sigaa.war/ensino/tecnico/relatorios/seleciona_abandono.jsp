...
<h2><ufrn:subSistema /> > Lista de Alunos Não Matriculados (Relatório de Abandono)</h2>

<h:form id="form">
<table align="center" class="formulario" width="40%">
	<caption class="listagem">Dados do Relatório</caption>
		<tr>
			<th style="text-align: right;">Ano-Período: </th>
			<td>
	...
	<tfoot>
		<tr>
			<td colspan="2" align="center">
				<h:commandButton id="gerarRelatorio" value="Gerar Relatório" action="#{relatoriosTecnico.gerarRelatorioAbandono}"/> 
