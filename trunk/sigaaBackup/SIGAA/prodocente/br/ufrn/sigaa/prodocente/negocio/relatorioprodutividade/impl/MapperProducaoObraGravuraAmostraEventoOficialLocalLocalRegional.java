...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 139
 * Descrição = Produção de obras de gravuras em amostras/eventos oficiais locais/regionais
 * @author Victor Hugo
 *
 */
public class MapperProducaoObraGravuraAmostraEventoOficialLocalLocalRegional
		extends AbstractMapperProducaoIntelectual<AudioVisual> {

	public MapperProducaoObraGravuraAmostraEventoOficialLocalLocalRegional() {
