...
/**
 * Entidade que registra os tipos de orientações que um docente da instituição pode realizar
 *
 * @author eric
 */
@Entity
...
public class TipoOrientacao implements Validatable {
	...
	public ListaMensagens validate() {
		...
		ValidatorUtil.validateRequired(getNivelEnsino(), "Nível de Ensino", lista);
		return lista;
	}
