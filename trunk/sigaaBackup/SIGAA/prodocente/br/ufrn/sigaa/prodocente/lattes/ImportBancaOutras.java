 ...
 *
 */
public class ImportBancaOutras extends ImportProducao<Banca> {

	public ImportBancaOutras(InputStream input, ImportLattesDao dao, List<? extends Producao> producoes) {
		super(input, dao, producoes, "OUTRAS-BANCAS-JULGADORAS");
	}

	@Override
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {

		if ("OUTRAS-BANCAS-JULGADORAS".equals(qName)) {
			item = new Banca();
		...
		if ("DADOS-BASICOS-DE-OUTRAS-BANCAS-JULGADORAS".equals(qName) && parse) {
