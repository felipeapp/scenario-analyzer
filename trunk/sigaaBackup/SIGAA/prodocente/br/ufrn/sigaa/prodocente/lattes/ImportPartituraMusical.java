...
/**
 * Classe que extrai dados referentes as Partituras Musicais - PRODUÇÕES BIBLIOGRÁFICAS.
 * 
 * @author David Pereira
 *
 */
public class ImportPartituraMusical extends ImportProducao<AudioVisual> {

	public ImportPartituraMusical(InputStream input, ImportLattesDao dao, List<? extends Producao> producoes) {
		super(input, dao, producoes, "PARTITURA-MUSICAL");
	}

	@Override
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
	
		if ("PARTITURA-MUSICAL".equals(qName)) {
			item = new AudioVisual();
			item.setSubTipoArtistico(new SubTipoArtistico(SubTipoArtistico.PARTITURA_MUSICAL_AUDIO_VISUAL));
		...
		if ("DADOS-BASICOS-DA-PARTITURA".equals(qName) && parse) {
		...
		if ("DETALHAMENTO-DA-PARTITURA".equals(qName) && parse) {
