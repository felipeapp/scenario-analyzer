...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 99
 * Descrição = Participação em banca examinadora de Tese ou Dissertação de Mestrado 
 * item = 7.7
 * @author Victor Hugo
 *
 */
public class MapperAtividadeParticipacaoBancaExaminadoraTeseDissertacao extends
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioBancaTeseMestrado(docente, ano, validade);
		}finally{ dao.close(); }
	}
