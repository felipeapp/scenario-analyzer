...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 129
 * Descrição = Produção de obras de desenho em amostras/eventos oficiais nacionais
 * @author Victor Hugo
 *
 */
public class MapperProducaoObraDesenhoAmostraEventoOficialNacional extends
		AbstractMapperProducaoIntelectual<AudioVisual> {

	public MapperProducaoObraDesenhoAmostraEventoOficialNacional() {
