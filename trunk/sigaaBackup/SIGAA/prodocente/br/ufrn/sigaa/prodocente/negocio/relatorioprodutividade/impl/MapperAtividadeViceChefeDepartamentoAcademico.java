...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 74
 * Descrição = Vice-chefe de departamento acadêmico
 * item = 6.1
 * @author Victor Hugo
 *
 */
public class MapperAtividadeViceChefeDepartamentoAcademico extends
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioViceChefeDepto(docente, ano, validade);
		}finally{ dao.close(); }
	}
