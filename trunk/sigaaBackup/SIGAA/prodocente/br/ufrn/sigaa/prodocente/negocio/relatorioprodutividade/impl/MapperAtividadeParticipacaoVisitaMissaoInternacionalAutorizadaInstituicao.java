...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 66
 * Descrição = Participação em visita ou missão Internacional, devidamente autorizada pela instituição para desenvolver atividades acadêmicas  
 * item 4.19
 * @author Victor Hugo
 *
 */
public class MapperAtividadeParticipacaoVisitaMissaoInternacionalAutorizadaInstituicao
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioParticipacaoVisitaMissaoInternacional(docente, ano, validade);
		}finally{ dao.close(); }
	}
