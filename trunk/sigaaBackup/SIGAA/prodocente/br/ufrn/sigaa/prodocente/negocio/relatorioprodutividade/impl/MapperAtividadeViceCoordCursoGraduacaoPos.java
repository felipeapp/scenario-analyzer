...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 75
 * Descrição = Vice-coordenador de curso de graduação ou Pós-Graduação
 * item = 6.2
 * @author Victor Hugo
 *
 */
public class MapperAtividadeViceCoordCursoGraduacaoPos extends
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioViceCoordenadorCurso(docente, ano, validade);
		}finally{ dao.close(); }
	}
