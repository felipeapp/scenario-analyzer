...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 97
 * Descrição = Participação em banca examinadora de concurso público para Técnico 
 * item = 7.5
 * @author Victor Hugo
 *
 */
public class MapperAtividadeParticipacaoBancaExaminadoraConcursoTecnico extends
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioBancaConcursoTecnico(docente, ano, validade);
		}finally{ dao.close(); }
	}
