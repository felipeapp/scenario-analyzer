...
/**prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 76
 * Descrição = Participação em Colegiados
 * item = 6.3
 * @author Victor Hugo
 *
 */
public class MapperAtividadeParticipacaoColegiado extends
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioParticipacaoColegiado(docente, ano, validade);
		}finally{ dao.close(); }
	}
