...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 158
 * Descrição = Relatório final de  pesquisa aprovado  pela instância competente da UFRN como coordenador
 * item = 8.49
 * @author Victor Hugo
 *
 */
public class MapperAtividadeRelatorioFinalPesquisaAprovadoInstanciaUFRNCoordenador
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioFinalPesquisaCoordenador(docente, ano, validade);
		}finally{ dao.close(); }
	}
