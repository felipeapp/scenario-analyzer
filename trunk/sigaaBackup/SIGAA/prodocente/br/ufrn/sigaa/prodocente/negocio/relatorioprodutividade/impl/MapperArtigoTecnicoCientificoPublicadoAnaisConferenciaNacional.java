...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 25
 * Descrição = Artigo técnico-científico publicado em anais de conferência nacional
 * @author Victor Hugo
 *
 */
public class MapperArtigoTecnicoCientificoPublicadoAnaisConferenciaNacional
		extends AbstractMapperProducaoIntelectual<Artigo> {

	public MapperArtigoTecnicoCientificoPublicadoAnaisConferenciaNacional() {
		super(Artigo.class);
	}
