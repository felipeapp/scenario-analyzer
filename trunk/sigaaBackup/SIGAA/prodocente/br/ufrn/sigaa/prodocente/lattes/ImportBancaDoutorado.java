...
/**
 * Classe que extrai dados referentes a Participação na Banca de Doutorado
 * 
 * @author David Pereira
 *
 */
public class ImportBancaDoutorado extends ImportProducao<Banca> {

	public ImportBancaDoutorado(InputStream input, ImportLattesDao dao, List<? extends Producao> producoes) {
		super(input, dao, producoes, "PARTICIPACAO-EM-BANCA-DE-DOUTORADO");
	}

	@Override
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {

		if ("PARTICIPACAO-EM-BANCA-DE-DOUTORADO".equals(qName)) {
			item = new Banca();
			item.setTipoBanca(new TipoBanca(TipoBanca.CURSO));
			item.setNaturezaExame(NaturezaExame.TESE_DOUTORADO);
		...
		if ("DADOS-BASICOS-DA-PARTICIPACAO-EM-BANCA-DE-DOUTORADO".equals(qName) && parse) {
		...
		if ("DETALHAMENTO-DA-PARTICIPACAO-EM-BANCA-DE-DOUTORADO".equals(qName) && parse) {
			//item.setInstituicao("NOME-INSTITUICAO");
		}
