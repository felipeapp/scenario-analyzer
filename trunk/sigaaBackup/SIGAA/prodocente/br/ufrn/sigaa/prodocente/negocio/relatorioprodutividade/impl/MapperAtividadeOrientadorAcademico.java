...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 108
 * Descrição = Orientador Acadêmico
 * item = 7.16
 * @author Victor Hugo
 *
 */
public class MapperAtividadeOrientadorAcademico extends AbstractMapperAtividade {
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioOrientadorAcademico(docente, ano, validade);
		}finally{ dao.close(); }
	}
