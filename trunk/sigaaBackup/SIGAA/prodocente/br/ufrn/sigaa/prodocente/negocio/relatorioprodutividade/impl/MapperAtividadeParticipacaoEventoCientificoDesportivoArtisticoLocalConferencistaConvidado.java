...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 70
 * Descrição = Participação em eventos científicos, desportivos ou artístico-culturais regionais como Conferencista Convidado  
 * item 4.23
 * @author Victor Hugo
 *
 */
public class MapperAtividadeParticipacaoEventoCientificoDesportivoArtisticoLocalConferencistaConvidado
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioParticipacaoEventoLocalConvidado(docente, ano, validade);
		}finally{ dao.close(); }
	}
