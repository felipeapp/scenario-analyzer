...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 154
 * Descrição = Publicação de livro didático, cultural ou técnico (na área de atividade acadêmica do docente) internacional com ISBN
 * @author Victor Hugo
 *
 */
public class MapperPublicacaoLivroDidaticoCulturalTecnicoInternacionalISBN
		extends AbstractMapperProducaoIntelectual<Livro> {

	public MapperPublicacaoLivroDidaticoCulturalTecnicoInternacionalISBN() {
		super(Livro.class);
	}
