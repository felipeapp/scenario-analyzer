...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 171
 * Descrição = Participação em Comitês Científicos (FINEP, CNPq, CAPES, Pró-reitorias, ética em pesquisa)
 * item = 8.58
 * @author Victor Hugo
 *
 */
public class MapperAtividadeParticipacapComitesCientificos extends
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findParticipacaoComiteCientifico(docente, ano, validade);
		}finally{ dao.close(); }
	}
