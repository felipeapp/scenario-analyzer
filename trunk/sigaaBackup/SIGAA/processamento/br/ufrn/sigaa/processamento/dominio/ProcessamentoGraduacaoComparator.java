 ...
 *
 */
public class ProcessamentoGraduacaoComparator implements Comparator<MatriculaEmProcessamento>{
	...
	public int compare(MatriculaEmProcessamento o1, MatriculaEmProcessamento o2) {
		...
		else if (comparaTipo == 0) return comparaIea(o1, o2);
		else return -1;
	}
	 ...
	 */
	private int comparaIea(MatriculaEmProcessamento o1, MatriculaEmProcessamento o2) {
