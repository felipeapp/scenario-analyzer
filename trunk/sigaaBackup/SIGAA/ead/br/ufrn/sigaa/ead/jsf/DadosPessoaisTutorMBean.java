 ...
 *
 */
@Component("dadosPessoaisTutor") @Scope("session")
public class DadosPessoaisTutorMBean extends SigaaAbstractController<TutorOrientador> implements OperadorDadosPessoais{

	/** a pessoa onde vai ser setada a pessoa alterada */
	Pessoa pessoaAlterada;

	public DadosPessoaisTutorMBean() {
	 ...
	 * @throws ArqException
	 */
	public String iniciarAlteracaoDadosTutor() throws ArqException{
		...
		dadosPessoaisMBean.setCodigoOperacao( OperacaoDadosPessoais.ALTERACAO_DADOS_TUTOR );
	...
	/**
	 * Realiza a submissão dos dados pessoais da pessoa
	 */
