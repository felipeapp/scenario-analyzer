...
/**
 * MBean responsável pela transferência dos discentes entre turmas do IMD.
 * 
 * @author Rafael Silva
 */
...
public class TransferenciaTurmaIMDMbean extends SigaaAbstractController<Object> {
	...
	/** Turmas de entrada do mesmos módulo/cronograma da turma de entrada selecionada */
	...
	public String efeturarTransferencia() throws ArqException {
		for (int i = 0; i < turmas.size(); i++) {
			if (turmas.get(i)==null) {
				addMessage("Tranferência não realizada. Não existem disciplinas abertas vinculadas ao aluno selecionado. ", TipoMensagemUFRN.ERROR);
				return null;
			}			
		}		
