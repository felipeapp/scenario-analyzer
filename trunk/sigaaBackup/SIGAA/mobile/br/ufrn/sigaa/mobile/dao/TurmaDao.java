...
public class TurmaDao extends GenericSigaaDAO {
	...
	public Collection<Turma> findTurmasMatriculado(DiscenteAdapter discente, CalendarioAcademico calendario) throws DAOException {
		String sql = "select coalesce(t.id_turma_agrupadora, t.id_turma) as id_turma, t.local, t.descricao_horario, t.ano, t.periodo, t.codigo, ccd.nome, cc.codigo as codigoCC, cc.permite_horario_flexivel, " +
...
//				cc.setPermiteHorarioFlexivel( (Boolean) mapa.get("permite_horario_flexivel") );
				t.setDisciplina(cc);
