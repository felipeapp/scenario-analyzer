...
import br.ufrn.sigaa.ensino.medio.dominio.ForumMedioTurmaDocente;
import br.ufrn.sigaa.pessoa.dominio.Pessoa;
import br.ufrn.sigaa.pessoa.dominio.Servidor;

/**
 * Managed-Bean responsável por associar docentes a fóruns de turmas/Serie de ensino médio.
 * 
 * @author arlindo
 * 
 */
@Component("forumMedioTurmaDocente") @Scope("request")
public class ForumMedioTurmaDocenteMBean extends SigaaAbstractController<ForumMedioTurmaDocente> {
	...
	/** Construtor padrão */
	public ForumMedioTurmaDocenteMBean() {
		init();
	...
	private void init(){
		obj = new ForumMedioTurmaDocente();
		obj.setServidor(new Servidor());
		obj.setForum(new ForumMedio());
