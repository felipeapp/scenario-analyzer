...
/**
 *
 * <p>DAO utilizado exclusivamente para o relatório de total de periódicos por área do CNPq. </p>
 * 
 * @author Felipe Rivas
 *
 */
public class RelatorioTotalPeriodicosPorCNPqDAO extends GenericSigaaDAO {
	 ...
	 * 
	 */
	public List<Object[]> findPeriodicosAreaAcervoByTombamentoBiblioteca(Collection<Integer> idBibliotecaList, Collection<Integer> idSituacaoMaterialList,
		...
		String sql = " SELECT a.id_assinatura as assinatura, a.internacional as internacional, count(f.id_fasciculo) as qtd, COALESCE(  COALESCE( info.nome, area.nome ), 'Sem Área') AS nomeArea  "+
		...
		" LEFT JOIN comum.area_conhecimento_cnpq area on area.id_area_conhecimento_cnpq = t."+classificacao.getColunaAreaConhecimentoCNPq()+
		...
		" GROUP BY a.id_assinatura, a.internacional, nomeArea ";
	...
	public List<Object[]> recuperaPeriodicidadeDataRegistroUltimoFasciculo(List<Integer> idsAssinatura) throws HibernateException, DAOException{
		...
		" WHERE f.id_assinatura IN ( :idsAssinatura ) "+
