...
import br.ufrn.sigaa.biblioteca.controle_estatistico.dao.RelatorioDeUsuariosComDevolucaoPorPeriodoDao;
import br.ufrn.sigaa.biblioteca.controle_estatistico.dao.RelatorioDeUsuariosComEmprestimosPorPeriodoDao;
import br.ufrn.sigaa.biblioteca.dominio.VinculoUsuarioBiblioteca;

/**
 * Relatório que mostra a quantidade de usuários que devolveram empréstimos num determinado
 ...
 * @version 1.0 Criação
 */
@Component("relatorioDeUsuariosComEmprestimosDevolvidosNumPeriodo")
@Scope("request")
public class RelatorioDeUsuariosComEmprestimosDevolvidosNumPeriodoMBean extends AbstractRelatorioBibliotecaMBean {
	
	/** A página do relatório. */
	private static final String PAGINA_DO_RELATORIO =
			"/biblioteca/controle_estatistico/relatorioUsuariosComEmprestimosDevolvidosNumPeriodo.jsp";
	
	/**
	 * <dl>
	 *   <dt>Chave</dt><dd>Tipo de usuário</dd></dl>
	 *   <dt>Elemento</dt><dd>Nº de usuários com empréstimos devolvidos</dd>
	 * </dl>
	 */
	...
	public RelatorioDeUsuariosComEmprestimosDevolvidosNumPeriodoMBean(){
	...
	public void configurar() {
		setTitulo("Quantitativo de Usuários que Devolveram Empréstimo por Período");
		
		setDescricao("Este relatório informa a quantidade de usuários que devolveram empréstimo em um determinado período. " +
	...
	public String gerarRelatorio() throws DAOException {
		...
		RelatorioDeUsuariosComDevolucaoPorPeriodoDao dao = null; 
		
		try{
			dao = getDAO(RelatorioDeUsuariosComDevolucaoPorPeriodoDao.class);
			...
			resultados = dao.findQtdUsuariosComEmprestimosDevolvidos(UFRNUtils.toInteger(variasBibliotecas), inicioPeriodo, fimPeriodo, vinculo);
