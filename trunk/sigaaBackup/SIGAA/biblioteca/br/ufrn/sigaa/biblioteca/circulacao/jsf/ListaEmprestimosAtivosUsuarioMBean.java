/*
 * ListaEmprestimosAtivosUsuarioMBean.java
 *
...
/**
 *    MBean que gerencia a página onde os empréstimos ativos de um determinado usuário
 * são mostrados. 
 * 
 * 		Há também a possibilidade de estornar qualquer um desses empréstimos, se o usuário for chefe da 
 ...
 *
 */
@Component("listaEmprestimosAtivosUsuarioMBean")
@Scope("request")
public class ListaEmprestimosAtivosUsuarioMBean extends SigaaAbstractController <Emprestimo> implements PesquisarUsuarioBiblioteca{

	/**
	 * Página que lista os empréstimos ativo do usuário
	 */
	public static final String PAGINA_LISTA_EMPRESTIMOS_ATIVOS_USUARIOS = "/biblioteca/circulacao/listaEmprestimosAtivos.jsp";
	 ...
	 * @throws ArqException 
	 */
	public String iniciaListaEmprestimos() throws ArqException{
		BuscaUsuarioBibliotecaMBean pBean = getMBean("buscaUsuarioBibliotecaMBean");
		return pBean.iniciar(this, true, true, true, false, "Listar os Empréstimos ativos do Usuário", null);
	}
	...
	public String selecionouUsuarioBuscaPadrao() throws ArqException {
		...
		checkRole(SigaaPapeis.BIBLIOTECA_SETOR_CIRCULACAO, SigaaPapeis.BIBLIOTECA_SETOR_CIRCULACAO_BIBLIOTECARIO, SigaaPapeis.BIBLIOTECA_ADMINISTRADOR_GERAL);
		...
		try {
			...
			emprestimosAtivos = emprestimoDAO.findEmprestimosAtivosByUsuarioMaterialBiblioteca(new UsuarioBiblioteca(idUsuarioBibliotecaRetornadoBuscaPadrao), null,null, false, null, null, null, null, null);
		
			return telaListaEmprestimosAtivosUsuario();
	 ...
	 * <br/>Método chamado pela seguinte JSP: /biblioteca/circulacao/listaEmprestimosAtivos.jsp
	 * 
	 * @return
	 */
	 ...
	 * @return
	 */
	private String telaListaEmprestimosAtivosUsuario(){
		return forward(PAGINA_LISTA_EMPRESTIMOS_ATIVOS_USUARIOS);
	}
