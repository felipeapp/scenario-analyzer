...
public class RelatorioMultasNaoPagasBibliotecaMBean extends AbstractRelatorioBibliotecaMBean{
	...
	/** Página que implementa o relatório de não em aberto. */
	...
	public void configurar() {
		...
		titulo = "Relatório de Multas a rerecer por Período";
		descricao = " <p> Neste relatório é possível consultar as multas que foram criadas mas ainda não foram pagas no período informado. </p> "
			+"<p> Para o período do relatório é considerada a data em que a multa foi criada </p>";
