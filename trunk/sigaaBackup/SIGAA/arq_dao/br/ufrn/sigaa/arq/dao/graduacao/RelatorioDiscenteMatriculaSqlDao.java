...
public class RelatorioDiscenteMatriculaSqlDao extends AbstractRelatorioSqlDao{
	...
	public List<Map<String, Object>> findAlunosIngressantesSemMatricula(int ano, int periodo) throws DAOException {
		...
		StringBuilder sqlconsulta = new StringBuilder(		
				...
				"t.sigla as turno, h.nome as habilitacao, me.descricao as modalidade ");
		sqlconsulta.append(		
				" FROM discente d" +
		...
		sqlconsulta.append(			
				...
				" AND d.status not in " +gerarStringIn( new int[] {StatusDiscente.CANCELADO, StatusDiscente.GRADUANDO, StatusDiscente.EXCLUIDO} )+
				" AND d.tipo = "+Discente.REGULAR);
		sqlconsulta.append(
				" GROUP BY fi.descricao, d.matricula, d.ano_ingresso, d.periodo_ingresso, p.nome, sd.descricao, c.nome, m.nome, t.sigla, h.nome, me.descricao" +
