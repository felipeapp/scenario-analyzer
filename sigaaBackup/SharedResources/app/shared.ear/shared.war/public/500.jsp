...
<%@page import="br.ufrn.arq.util.ValidatorUtil"%><html class="background">
    <head>
	   ...
	   <title>${ configSistema['siglaInstituicao'] } - <%= nome %></title>
...
<div class="principal">
	<div class="colEsq">
		<p class="bgEsqTop inesperado"></p>
		<p class="icon"><img src="/shared/img/icon_500.jpg" align="center"/></p>
	...
	<div class="colDir">
		<p></p>
		<p class="titDir">Desculpe, comportamento inesperado!</p>
		<p class="bgDirTop"></p>
		<p class="bgDir">
			Caro Usuário,<br/><br/> 
			Desculpe, o sistema se comportou de forma
inesperada. Entre em contato com a nossa equipe de suporte através da opção 
"Abrir Chamado".<br/><br/>   
      Siga uma das opções abaixo para continuar navegando em nosso sistema:
