...
public class FormaAtuacaoDocenciaAssistida implements Validatable {
	/** Chave primária */
	private int id;
	/** Descrição da forma de aturação */
	private String descricao;
	/** Indica se a forma de atuação está ativa ou não */
	private boolean ativo = true;
	/** Atributo Transient que indica se a forma de atuação está ou não selecionada */
