...
public class PaginacaoTag extends TagSupport{
    ...
    private static final String script =
        ...
        + "function paginacao(pagina) { "
        	...
        	+ "pageNum.value = pagina;\n "
        	+ "document.getElementById('submitPaginacao').click();\n"
        	+ "} "
        + "function valida(campo) {" 
        	...
        	+ "if (pagina <= 0 || pagina == undefined)\n"
        		+ "throw new Error(\"\");\n"
        	+ "else if (pagina > document.getElementById('pageMax').value)\n"
        		+ "campo.value = document.getElementById('pageMax').value;\n"
        	+ "}"
        	+ "catch (erro) {\n"
        		+ "campo.value = \"1\";\n"
        	+ "}\n"
        	+ "document.getElementById('pageNum').value = campo.value;\n"
        + "}\n" +
        "</script>";
    ...
    public String renderLinksPaginacao() throws JspException {
        ...
        results.append(" <img src=\""+contexto+"img/" + imgPrim + ".gif\" border=\"0\"");
        ...
        results.append("  <img src=\""+contexto+"img/" + imgAnte + ".gif\" border=\"0\"");
        if (pageNum.intValue() > 1)
        ...
        results.append(lineEnd);
        results.append("  <input name=\"pagina\" id=\"pagina\" type=\"text\" size=\"3\" onchange=\"valida(this);\">");
        results.append(lineEnd);
        results.append("</td>");
        results.append(lineEnd);
        
        results.append("<td align=\"left\">");
        results.append("  <img src=\""+contexto+"img/" + imgProx + ".gif\" border=\"0\"");
        ...
        results.append("<td align=\"left\">");
        results.append("  <img src=\""+contexto+"img/" + imgUltm + ".gif\" border=\"0\"");
        if (pageMax.intValue() != pageNum.intValue())
    ...
    protected void lookup() throws JspException {
        ...
        pageNum = (Integer) pageContext.getRequest().getAttribute("formPageNum");
