...
/**
 * Processador para cadastro de manifestações feitas por um discente.
 * 
 * @author Bernardo
 *
 */
public class ProcessadorManifestacaoDiscente extends AbstractProcessadorManifestacao {
    ...
    public Object execute(Movimento mov) throws NegocioException, ArqException, RemoteException {
		...
		if(mov.getCodMovimento().equals(SigaaListaComando.CADASTRAR_MANIFESTACAO_DISCENTE)) {
