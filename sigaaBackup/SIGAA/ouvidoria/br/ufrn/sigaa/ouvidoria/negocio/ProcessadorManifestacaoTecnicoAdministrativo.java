...
/**
 * Processador para cadastro de manifestações de um técnico administrativo feito pela ouvidoria.
 * 
 * @author Bernardo
 *
 */
public class ProcessadorManifestacaoTecnicoAdministrativo extends AbstractProcessadorManifestacao {
    ...
    public Object execute(Movimento mov) throws NegocioException, ArqException, RemoteException {
		...
		if(mov.getCodMovimento().equals(SigaaListaComando.CADASTRAR_MANIFESTACAO_TECNICO_ADMINISTRATIVO)) {
