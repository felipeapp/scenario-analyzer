 ...
 *
 */
@Component("relatorioMultasPagasBibliotecaMBean")
@Scope("request")
public class RelatorioMultasPagasBibliotecaMBean extends AbstractRelatorioBibliotecaMBean{

	/** Página que implementa o relatório de multas pagas no sistema. */
	private static final String PAGINA_RELATORIO_MULTAS_PAGAS = "/biblioteca/controle_estatistico/multas/paginaRelatorioMultasPagas.jsp";
	...
	public RelatorioMultasPagasBibliotecaMBean(){
	...
	public void configurar() {
		...
		titulo = "Relatório de Multas Pagas por Período";
		descricao = " <p> Neste relatório é possível consultar as multas que foram pagas no período informado. </p> "
			+" <p> Para uma multa ser considerada paga, ela deve ter sido paga utilizando a GRU e em seguida realizada a confirmação desse pagamento no sistema. </p> "
			+"<p> Para o período do relatório é considerada a data em que a multa foi paga no sistema. </p>";
	...
	public String gerarRelatorio() throws DAOException {
		...
		resultado = multasDao.findMultasPagasPorPeriodo(UFRNUtils.toInteger(variasBibliotecas), inicioPeriodo, fimPeriodo);
		...
		return forward(PAGINA_RELATORIO_MULTAS_PAGAS);
