/*
 * ListaRenovacoesAtivasUsuarioMBean.java
 *
...
/**
 *    MBean que gerencia a página onde as renovações ativas de um determinado usuário
 * são mostradas. 
 * 
 * 		Há também a possibilidade de estornar qualquer uma dessas renovações, se o usuário for chefe da 
 ...
 *
 */
@Component("listaRenovacoesAtivasUsuarioMBean")
@Scope("request")
public class ListaRenovacoesAtivasUsuarioMBean extends SigaaAbstractController <Emprestimo> implements PesquisarUsuarioBiblioteca{

	/**
	 * Página que lista os empréstimos ativo do usuário
	 */
	public static final String PAGINA_LISTA_RENOVACOES_ATIVAS_USUARIO = "/biblioteca/circulacao/listaRenovacoesAtivas.jsp";
	...
	/**
	 * A lista de renovações em aberto do usuário.
	 */
	private List<Emprestimo> renovacoesAtivas;
	 ...
	 * @throws ArqException 
	 */
	public String iniciaListaRenovacoes() throws ArqException{
		BuscaUsuarioBibliotecaMBean pBean = getMBean("buscaUsuarioBibliotecaMBean");
		return pBean.iniciar(this, true, true, true, false, "Listar as Renovações ativas do Usuário", null);
	}
	...
	public String selecionouUsuarioBuscaPadrao() throws ArqException {
		...
		try {
			...
			renovacoesAtivas = emprestimoDAO.findRenovacoesAtivasByUsuario(new UsuarioBiblioteca(idUsuarioBibliotecaRetornadoBuscaPadrao));
		
			return telaListaRenovacoesAtivasUsuario();
	 ...
	 * <br/>Método chamado pela seguinte JSP: /biblioteca/circulacao/listaRenovacoesAtivas.jsp
	 * 
	 * @return
	 */
	...
	/**
	 * Exibe a listagem das renovações ativas do usuário.
	 * @return
	 */
	private String telaListaRenovacoesAtivasUsuario(){
		return forward(PAGINA_LISTA_RENOVACOES_ATIVAS_USUARIO);
	}
	...
	public List<Emprestimo> getRenovacoesAtivas() {
		return renovacoesAtivas;
	}

	public void setRenovacoesAtivas(List<Emprestimo> renovacoesAtivas) {
		this.renovacoesAtivas = renovacoesAtivas;
	}
