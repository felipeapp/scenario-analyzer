 ...
 * materiais de um título na parte pública do sistema.
 * 
 * @author jadson
 *
 */
...
public class DetalhesMateriaisDeUmTituloPublicoMBean extends DetalhesMateriaisMBean{
	...
	/** visualiza os materiais de um Título na parte pública do sistema */
	...
	/**
	 * Método responsável por realizar a pesquisa através de solicitações externas via parâmetro idTitulo.
	 * <br/>
	 * Método chamado pela(s) seguinte(s) JSP(s):
	 * <ul>
	...
	protected void carregaDadosMateriais() throws DAOException {
		...
		// Registra a visualizacao desse Título pelo usuário /// 
...
//	/**
//	 *
//	 * Chamado a partir da página: public/biblioteca/paginaDetalhesMateriaisPublica.jsp
//	 * 
//	 *
