 ...
 * Baseado no MBean NotificacoesBean. Foi recriado para ser modificado e utilizado no módulo do IMD.
 * Os controladores específicos de cada módulo deverão estendê-lo e definir os destinatários.
 * 
 * @author Rafael Barros
 */
@Component("notificacoesIMD") @Scope("request")
public class NotificacoesIMDMBean extends AbstractControllerNotificacoes {
	...
	public static final String FORM_MENSAGEM = "/metropole_digital/mensagem/enviar_mensagem.jsf";
