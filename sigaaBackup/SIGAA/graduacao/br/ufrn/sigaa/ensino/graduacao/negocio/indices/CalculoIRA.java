...
/**
 * Classe responsável pelo cálculo do IRA (Índice de 
 * Rendimento Acadêmico).
 * 
 * Regulamento dos Cursos de Graduação - Art. 115. O Índice de 
 * Rendimento Acadêmico (IRA) é a média do rendimento escolar final 
