...
/**
 * Entidade Responsável pelo gerenciamento dos Tipo Procedência dos Alunos, se é da própria
 * Instituição de Ensino, se é de outra Instituição de Ensino ou se não foi informado.
 */
@Entity
