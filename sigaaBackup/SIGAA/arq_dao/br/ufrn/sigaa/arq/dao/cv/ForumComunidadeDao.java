...
public class ForumComunidadeDao extends GenericSigaaDAO {
	 ...
	 * @return
	 */
	public List<ForumMensagemComunidade> findListaMensagensForumByIDForum(int forumSelecionado) throws DAOException {
		...
		"order by coalesce(fm.ultimaPostagem, '-infinity') DESC";
