...
/**
 * Classe que extrai dados referentes a Tese de Doutorado do Docente- FORMACAO ACADEMICA
 * Criada em: (15/09/03 10:38:45)
 * 
...
@Deprecated
public class ImportFormacaoDoutorado extends ImportProducao<FormacaoAcademica> {

	public ImportFormacaoDoutorado(InputStream input, ImportLattesDao dao, List<? extends Producao> producoes) {
