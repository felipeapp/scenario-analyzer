...
/**
 * Classe que extrai dados referentes a Participação em Banca de Qualificação de Doutorado
 * 
 * @author David Pereira
 *
 */
public class ImportBancaQualificacao extends ImportProducao<Banca> {

	public ImportBancaQualificacao(InputStream input, ImportLattesDao dao, List<? extends Producao> producoes) {
		super(input, dao, producoes, "PARTICIPACAO-EM-BANCA-DE-EXAME-QUALIFICACAO");
	}

	@Override
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {

		if ("PARTICIPACAO-EM-BANCA-DE-EXAME-QUALIFICACAO".equals(qName)) {
			item = new Banca();
		...
		if ("DADOS-BASICOS-DA-PARTICIPACAO-EM-BANCA-DE-EXAME-QUALIFICACAO".equals(qName) && parse) {
		...
		if ("DETALHAMENTO-DA-PARTICIPACAO-EM-BANCA-DE-EXAME-QUALIFICACAO".equals(qName) && parse) {
