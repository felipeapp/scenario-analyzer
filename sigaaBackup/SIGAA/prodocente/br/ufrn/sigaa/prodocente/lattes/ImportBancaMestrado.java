...
/**
 * Classe que extrai dados referentes a Participação em Banca de Mestrado
 * 
 * @author David Pereira
 *
 */
public class ImportBancaMestrado extends ImportProducao<Banca> {

	public ImportBancaMestrado(InputStream input, ImportLattesDao dao, List<? extends Producao> producoes) {
		super(input, dao, producoes, "PARTICIPACAO-EM-BANCA-DE-MESTRADO");
	}

	@Override
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {

		if ("PARTICIPACAO-EM-BANCA-DE-MESTRADO".equals(qName)) {
			item = new Banca();
			item.setTipoBanca(new TipoBanca(TipoBanca.CURSO));
			item.setNaturezaExame(NaturezaExame.DISSERTACAO_MESTRADO);
		...
		if ("DADOS-BASICOS-DA-PARTICIPACAO-EM-BANCA-DE-MESTRADO".equals(qName) && parse) {
		...
		if ("DETALHAMENTO-DA-PARTICIPACAO-EM-BANCA-DE-MESTRADO".equals(qName) && parse) {
