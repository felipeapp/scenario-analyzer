...
/**
 * Classe que extrai dados referentes a Participação em Banca de Graduação
 * 
 * @author David Pereira
 *
 */
public class ImportBancaGraduacao extends ImportProducao<Banca> {

	public ImportBancaGraduacao(InputStream input, ImportLattesDao dao, List<? extends Producao> producoes) {
		super(input, dao, producoes, "PARTICIPACAO-EM-BANCA-DE-GRADUACAO");
	}
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
		...
		if ("PARTICIPACAO-EM-BANCA-DE-GRADUACAO".equals(qName)) {
			item = new Banca();
			item.setTipoBanca(new TipoBanca(TipoBanca.CURSO));
			item.setNaturezaExame(NaturezaExame.MONOGRAFIA_GRADUACAO);
		...
		if ("DADOS-BASICOS-DA-PARTICIPACAO-EM-BANCA-DE-GRADUACAO".equals(qName) && parse) {
		...
		if ("DETALHAMENTO-DA-PARTICIPACAO-EM-BANCA-DE-GRADUACAO".equals(qName) && parse) {
