...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 81
 * Descrição = Participação em comissões de sindicância ou de processos de natureza disciplinar
 * item = 6.7
 * @author Victor Hugo
 *
 */
public class MapperAtividadeParticipacaoComissaoSindicanciaProcessoDisciplinar
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioParticipacaoComissaoSindicancia(docente, ano, validade);
		}finally{ dao.close(); }
	}
