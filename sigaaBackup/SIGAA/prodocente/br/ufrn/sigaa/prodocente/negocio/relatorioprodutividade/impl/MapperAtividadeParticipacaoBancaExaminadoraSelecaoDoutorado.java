...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 103
 * Descrição = Participação em banca examinadora de Seleção de Doutorado
 * item = 7.11
 * @author Victor Hugo
 *
 */
public class MapperAtividadeParticipacaoBancaExaminadoraSelecaoDoutorado extends
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioBancaSelecaoDoutorado( docente, ano, validade);
		}finally{ dao.close(); }
