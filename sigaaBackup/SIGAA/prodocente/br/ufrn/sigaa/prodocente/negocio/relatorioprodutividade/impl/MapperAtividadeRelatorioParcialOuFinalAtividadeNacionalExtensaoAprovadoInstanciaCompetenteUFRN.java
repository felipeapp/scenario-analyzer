...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 163
 * Descrição = Relatório parcial, ou final  de atividades (Nacional) de extensão, aprovado em instâncias competentes na UFRN
 * item 4.2
 * @author Victor Hugo
 *
 */
public class MapperAtividadeRelatorioParcialOuFinalAtividadeNacionalExtensaoAprovadoInstanciaCompetenteUFRN
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			Collection<? extends ViewAtividadeBuilder> rels = dao.findRelatorioAtividadeNacional1( docente, ano, validade);
			Collection<? extends ViewAtividadeBuilder> projetos = dao.findRelatorioAtividadeNacional2( docente, ano, validade);
