 ...
 */
public class MapperResumoExpandidoAnaisEventoLocal
		extends AbstractMapperProducaoIntelectual<Producao> {

	public MapperResumoExpandidoAnaisEventoLocal() {
	...
	protected boolean isAtendeCriterios(Producao producao) {
		if ( producao instanceof PublicacaoEvento ) {
            ...
            // item 3.19.1
            return ( p.getTipoRegiao() == null || p.getTipoRegiao().getId() == TipoRegiao.LOCAL ) 
