...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 156
 * Descrição = Capítulo de livro didático, cultural ou técnico (na área de atividade acadêmica do docente) internacional com ISBN
 * @author Victor Hugo
 *
 */
public class MapperCapituloLivroDidaticoCulturalTecnicoInternacionalISBN extends
		AbstractMapperProducaoIntelectual<Capitulo> {

	public MapperCapituloLivroDidaticoCulturalTecnicoInternacionalISBN() {
