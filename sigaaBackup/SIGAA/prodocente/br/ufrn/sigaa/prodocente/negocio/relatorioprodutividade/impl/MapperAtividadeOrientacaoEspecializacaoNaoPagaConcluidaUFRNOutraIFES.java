...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 149
 * Descrição = Orientação de Especialização não paga concluída na UFRN e outra IFES
 * item = 8.40
 * @author Victor Hugo
 *
 */
public class MapperAtividadeOrientacaoEspecializacaoNaoPagaConcluidaUFRNOutraIFES
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findOrientacoesPosEspecializacaoConcluidaDocente(docente, ano, validade);
		}finally{ dao.close(); }
	}
