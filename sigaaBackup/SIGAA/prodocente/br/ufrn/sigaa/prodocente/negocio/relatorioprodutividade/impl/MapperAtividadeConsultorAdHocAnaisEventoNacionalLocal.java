...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 89
 * Descrição = Consultor "ad hoc" de anais de evento nacional ou local 
 * item = 6.15
 * @author Victor Hugo
 *
 */
public class MapperAtividadeConsultorAdHocAnaisEventoNacionalLocal extends
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioConsultorAdHocAnaisNacionalRegional(docente, ano, validade);
		}finally{ dao.close(); }
	}
