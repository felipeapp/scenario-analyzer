...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 68
 * Descrição = Participação em eventos científicos, desportivos ou artístico-culturais nacionais como Conferencista Convidado  
 * item 4.21
 * @author Victor Hugo
 *
 */
public class MapperAtividadeParticipacaoEventoCientificoDesportivoArtisticoNacionalConferencistaConvidado
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioParticipacaoEventoNacionalConvidado(docente, ano, validade);
		}finally{ dao.close(); }
	}
