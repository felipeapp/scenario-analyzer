...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 92
 * Descrição = Consultor "ad hoc" de comissão nacional de reforma e avaliação de cursos 
 * item = 6.18
 * @author Victor Hugo
 *
 */
public class MapperAtividadeConsultorAdHocComissaoNacionalReformaAvaliacaoCurso
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioConsultorAdHocReformaAvaliacaoCurso(docente, ano, validade);
		}finally{ dao.close(); }
	}
