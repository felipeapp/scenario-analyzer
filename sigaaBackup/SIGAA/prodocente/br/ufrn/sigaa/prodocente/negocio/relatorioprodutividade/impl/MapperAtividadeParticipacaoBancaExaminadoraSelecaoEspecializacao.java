...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 106
 * Descrição = Participação em banca examinadora de Seleção de Especialização
 * item = 7.14
 * @author Victor Hugo
 *
 */
public class MapperAtividadeParticipacaoBancaExaminadoraSelecaoEspecializacao
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioBancaSelecaoEspecializacao(docente, ano, validade);
		}finally{ dao.close(); }
	}
