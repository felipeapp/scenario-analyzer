...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 88
 * Descrição = Consultor "ad hoc" de anais de evento internacional
 * item = 6.14
 * @author Victor Hugo
 *
 */
public class MapperAtividadeConsultorAdHocAnaisEventoInternacional extends
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioConsultorAdHocAnaisInternacional(docente, ano, validade);
		}finally{ dao.close(); }
	}
