...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 101
 * Descrição = Participação em banca examinadora de Qualificação de Mestrado 
 * item = 7.9
 * @author Victor Hugo
 *
 */
public class MapperAtividadeParticipacaoBancaExaminadoraQualificacaoMestrado
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioBancaQualificacaoMestrado(docente, ano, validade);
		}finally{ dao.close(); }
	}
