...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 14
 * Descrição = Tese  ou Dissertação de mestrado defendida com aprovação
 * item 3.2
 * @author Victor Hugo
 *
 */
public class MapperAtividadeTeseDissertacaoMestradoDefendidaPeloDocenteAprovacao
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		Collection<FormacaoAcademicaDTO> formacoesDTO = serviceFormacao.consultarFormacaoAcademica(docente.getId(), null, null, null,  null,	
				CalendarUtils.createDate(01, 01, ( ano - validade )), CalendarUtils.createDate(31, 12, ano), Formacao.MESTRE) ;
