...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 90
 * Descrição = Consultor "ad hoc" de órgão de fomento 
 * item = 6.16
 * @author Victor Hugo
 *
 */
public class MapperAtividadeConsultorAdHocOrgaoFomento extends
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioConsultorAdHocOrgaoFormento(docente, ano, validade);
		}finally{ dao.close(); }
	}
