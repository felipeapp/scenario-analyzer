...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 174
 * Descrição = Componentes curriculares ministrados na pós-graduação stricto sensu
 * item = 8.61
 * @author Victor Hugo
 *
 */
public class MapperAtividadeComponenteCurricularMinistradoPosStricto extends
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findComponentesEnsinoPosStricto(docente, ano, validade);
		}finally{ dao.close(); }
	}
