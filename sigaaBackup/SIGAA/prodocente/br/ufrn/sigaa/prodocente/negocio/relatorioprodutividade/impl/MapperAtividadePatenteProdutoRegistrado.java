...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 55
 * Descrição = Patente ou produto registrado (aparelho ou instrumento, equipamento, fármaco, outros) registrado (na área de atividade acadêmica do docente) 
 * item 4.8
 * @author Victor Hugo
 *
 */
public class MapperAtividadePatenteProdutoRegistrado extends
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioPatenteProduto( docente, ano, validade);
		}finally{ dao.close(); }
	}
