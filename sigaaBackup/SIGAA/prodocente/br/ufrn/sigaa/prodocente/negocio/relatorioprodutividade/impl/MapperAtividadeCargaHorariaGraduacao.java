...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 170
 * Descrição = Carga Horária na graduação
 * item = 8.57
 * @author Victor Hugo
 *
 */
public class MapperAtividadeCargaHorariaGraduacao extends
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findCargaHorariaGraduacaoSintetico(docente, ano, validade);
		}finally{ dao.close(); }
	}
