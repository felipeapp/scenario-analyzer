...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 104
 * Descrição = Participação em banca examinadora de Seleção de Mestrado
 * item = 7.12
 * @author Victor Hugo
 *
 */
public class MapperAtividadeParticipacaoBancaExaminadoraSelecaoMestrado extends
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioBancaSelecaoMestrado(docente, ano, validade);
		}finally{ dao.close(); }
	}
