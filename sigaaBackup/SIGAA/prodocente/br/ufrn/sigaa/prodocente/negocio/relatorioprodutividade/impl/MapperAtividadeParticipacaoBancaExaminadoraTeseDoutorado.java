...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 98
 * Descrição = Participação em banca examinadora de Tese de Doutorado 
 * item = 7.6
 * @author Victor Hugo
 *
 */
public class MapperAtividadeParticipacaoBancaExaminadoraTeseDoutorado extends
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioBancaTeseDoutorado(docente, ano, validade);
		}finally{ dao.close(); }
	}
