...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 80
 * Descrição = Participação em comissões temporárias
 * item = 6.6
 * @author Victor Hugo
 *
 */
public class MapperAtividadeParticipacaoComissaoTemporaria extends
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioParticipacaoComissaoTemporarias(docente, ano, validade);
		}finally{ dao.close(); }
	}
