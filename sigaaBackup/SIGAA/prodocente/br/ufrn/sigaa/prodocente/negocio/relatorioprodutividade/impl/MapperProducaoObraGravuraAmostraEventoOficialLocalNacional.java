...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 138
 * Descrição = Produção de obras de gravuras em amostras/eventos oficiais nacionais
 * @author Victor Hugo
 *
 */
public class MapperProducaoObraGravuraAmostraEventoOficialLocalNacional extends
		AbstractMapperProducaoIntelectual<AudioVisual> {

	public MapperProducaoObraGravuraAmostraEventoOficialLocalNacional() {
