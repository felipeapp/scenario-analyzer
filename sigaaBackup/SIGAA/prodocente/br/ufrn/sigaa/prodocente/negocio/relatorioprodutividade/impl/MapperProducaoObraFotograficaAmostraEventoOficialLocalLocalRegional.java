...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 136
 * Descrição = Produção de obras fotográficas em amostras/eventos oficiais locais/regionais
 * @author Victor Hugo
 *
 */
public class MapperProducaoObraFotograficaAmostraEventoOficialLocalLocalRegional
		extends AbstractMapperProducaoIntelectual<AudioVisual> {

	public MapperProducaoObraFotograficaAmostraEventoOficialLocalLocalRegional() {
