...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 175
 * Descrição = Orientação - Pós-Doutorado na UFRN e outras IFES
 * item 2.10
 * @author Victor Hugo
 *
 */
public class MapperAtividadeOrientacaoPosDoutoradoUfrnOutraIFES extends
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			Collection<? extends ViewAtividadeBuilder> atividades = dao.findOrientacoesPosDocDocente(docente, ano);
			return atividades;
		}finally{ dao.close(); }
	}
