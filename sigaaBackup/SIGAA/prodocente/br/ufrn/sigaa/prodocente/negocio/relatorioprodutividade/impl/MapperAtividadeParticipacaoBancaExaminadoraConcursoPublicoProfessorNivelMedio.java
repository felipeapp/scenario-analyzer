...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 96
 * Descrição = Participação em banca examinadora de concurso público para professor Nível Médio 
 * item = 7.4
 * @author Victor Hugo
 *
 */
public class MapperAtividadeParticipacaoBancaExaminadoraConcursoPublicoProfessorNivelMedio
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioBancaConcursoProfessorMedio(docente, ano, validade);
		}finally{ dao.close(); }
	}
