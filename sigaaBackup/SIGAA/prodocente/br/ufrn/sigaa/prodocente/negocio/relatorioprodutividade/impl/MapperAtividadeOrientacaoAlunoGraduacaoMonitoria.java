...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 151
 * Descrição = Orientação de alunos de graduação em monitoria nas atividades acadêmicas. 
 * item = 8.42
 * @author Victor Hugo
 *
 */
public class MapperAtividadeOrientacaoAlunoGraduacaoMonitoria extends
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioOrientacaoAlunosGraduacao3(docente, ano, validade);
		}finally{ dao.close(); }
	}
