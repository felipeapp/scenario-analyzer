...
/**
 * prodocente.item_relatorio_produtividade.id_item_relatorio_produtividade = 95
 * Descrição = Participação em banca examinadora de concurso público para professor Substituto 
 * item = 7.3
 * @author Victor Hugo
 *
 */
public class MapperAtividadeParticipacaoBancaExaminadoraConcursoPublicoProfessorSubstituto
	...
	public Collection<? extends ViewAtividadeBuilder> buscarAtividades(
		...
		try{
			...
			return dao.findRelatorioBancaConcursoProfessorSubstituto(docente, ano, validade);
		}finally{ dao.close(); }
	}
