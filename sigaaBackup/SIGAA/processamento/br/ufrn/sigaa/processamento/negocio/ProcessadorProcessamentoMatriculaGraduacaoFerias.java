...
/**
 * Processador para realizar o processamento da matrícula em disciplinas de Férias.
 ...
 *
 */
public class ProcessadorProcessamentoMatriculaGraduacaoFerias extends AbstractProcessador {

	public Object execute(Movimento mov) throws NegocioException, ArqException, RemoteException {

		ProcessamentoMatriculaDao dao = getDAO(ProcessamentoMatriculaGraduacaoFeriasDao.class, mov);
		...
		try {
			...
			Map<Integer, List<MatriculaEmProcessamento>> matriculas = dao.findMatriculasEmOrdemParaProcessamento(turma, vagasReservadas, false);
			...
			dao.registrarProcessamentoTurma(turma.getAno(), turma.getPeriodo(), false, turma, resultadoProcessamento);
