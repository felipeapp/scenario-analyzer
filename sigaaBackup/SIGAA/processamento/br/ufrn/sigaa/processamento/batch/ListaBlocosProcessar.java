...
/**
 * Classe que armazena a lista de turmas de bloco a serem pós-processadas
 * 
 * @author David Pereira
 *
 */
public class ListaBlocosProcessar {
	...
	public static synchronized void carregarDiscentes(int ano, int periodo, char nivel, boolean rematricula) throws DAOException {
		...
		try {
			...
			List<Integer> discentesBuscados = dao.findDiscentesMatriculadosEmBlocos(ano, periodo, rematricula);
