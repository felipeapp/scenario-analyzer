...
<f:view>
	...
	<h:outputText value="#{tipoAtividadeComplementar.create}" />
	...
	<center>
			...
			<div class="infoAltRem">
				<h:form>
					...
					<h:commandLink action="#{tipoAtividadeComplementar.preCadastrar}" value="Cadastrar"/>
				</h:form>
			</div>
	</center>
	...
	<table class=formulario width="50%">
		<tr>
			<caption class="listagem">Lista de Tipos de Atividades Complementares</caption>
			<thead>
				<td>Descrição</td>
			</thead>
		</tr>
		<c:forEach items="${tipoAtividadeComplementar.allPaginado}" var="item" varStatus="status">
