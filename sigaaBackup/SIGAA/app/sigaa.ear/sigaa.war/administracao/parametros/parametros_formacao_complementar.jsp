	...
	<h:form id="form">
		<table class="formulario" width="100%">
			...
			<tbody>
				...
				<tr>
					<th>Verifica a quantidade de letras no código do Componente Curricular:</th>
					<td><h:selectBooleanCheckbox value="#{parametros.obj.validaQtdLetrasCodigo}" id="validaQtdLetrasCodigo" /> </td>
				</tr>
			</tbody>
			<tfoot>
				<tr>
