...
<f:view>
	...
	<h:form id="form">
		...
		<caption> Identificação </caption>
			...
			<tr>
				<td colspan="2">
				<rich:dataTable id="dtPermanentes" value="#{ avaliacaoProjetoApoioGrupoPesquisaMBean.projeto.grupoPesquisa.equipesGrupoPesquisaCol }" 
					var="membro" width="100%" styleClass="subFormulario" rowClasses="linhaPar, linhaImpar" binding="#{avaliacaoProjetoApoioGrupoPesquisaMBean.membros}">
