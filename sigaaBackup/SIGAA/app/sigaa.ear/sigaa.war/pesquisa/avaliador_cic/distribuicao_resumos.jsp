...
<f:view>
	...
	<h2><ufrn:subSistema /> &gt; Distribuição de Resumos para Avaliadores de Trabalhos do CIC</h2>
	...
	<h:form id="form">
		<table class="formulario" width="100%">
			...
			<tfoot>
				<tr>
					<td colspan="2"><h:commandButton value="Gravar Distribuição" action="#{avaliacaoResumoBean.gravar}" /> <h:commandButton
