...
<h2> Biblioteca &gt;  Histórico das Últimas Alterações  do Título </h2>
...
.tabelaRelatorioBorda td, td{
	border: 1px solid  #EEEEEE;
			...
			<c:set var="listaModificacoes" value="${catalogacaoMBean.historicoAlteracaoTitulo}"></c:set>
					...
					<table width="90%" style="margin-right: auto; margin-left: auto">
						<tr>
							<td style="text-align: center; font-weight:bold;  font-size: 18px">
								O Título não possui histório de alterações ainda.
							</td>
						</tr>
					</table>
			</c:if>
				...
				<table class="tabelaRelatorioBorda" style="width:100%;">
					...
					<thead>
						<tr>
							...
							<th style="text-align:left; width: 50%">Informações do Título </th>
						</tr>
					</thead>
