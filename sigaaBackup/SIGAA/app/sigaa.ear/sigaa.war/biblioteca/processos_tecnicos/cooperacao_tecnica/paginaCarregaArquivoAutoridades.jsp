...
<h2>  <ufrn:subSistema /> &gt; Carregar Arquivo de Números de Controle de Autoridades </h2>
	...
	<h:form id="formCarregaArquivoTitulo" enctype="multipart/form-data">
		...
		<c:if test="${fn:length( cargaArquivoFGVMBean.arquivosCarregadosAtivos) > 0}">
			...
			<table class="listagem" style="margin-bottom: 20px; width: 90%;">
				<caption> Arquivos de Autoridades Carregados no Sistema</caption>
		...
		<table class="formulario" style="width: 70%">
			...
			<tr style="text-align:center;">
				...
				<td style="margin-bottom:20px; text-align:left;">
					...
					<ufrn:help> Um número neste formato: YY000670211, fornecido pela FGV.</ufrn:help>
				</td>
				...
				<td style="margin-bottom:20px; text-align:left;">
					...
					<ufrn:help> Um número neste formato: YY000675205, fornecido pela FGV.</ufrn:help>
				</td>
