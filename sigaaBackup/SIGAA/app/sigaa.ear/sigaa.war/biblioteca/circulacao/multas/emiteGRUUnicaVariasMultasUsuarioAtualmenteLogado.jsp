...
<f:view>
		...
		<h:form id="formImprimirGRUUnica">
			...
			<caption>Multas do Usuário não Pagas ( ${fn:length(emitirGRUPagamentoMultasBibliotecaMBean.multasAtivasUsuario)} )</caption>
				...
				<tfoot>
					<tr>
						<td colspan="6" style="text-align: center;">
							<h:commandButton id="cmdEmitirGRUUnica"   value="Confirmar Emissão para as Multas Selecionadas" action="#{emitirGRUPagamentoMultasBibliotecaMBean.emitirGRUUnicaParaMultasAbertas}" />
							<h:commandButton id="cmdCancelar"  value="Cancelar" action="#{emitirGRUPagamentoMultasBibliotecaMBean.telaListaMultasUsuario}" immediate="true" />
						</td>
					</tr>
				</tfoot>
