...
<f:view>
	...
	&nbsp&nbsp&nbsp  <strong>Observação:</strong> A quantidade de títulos exibida representa a quantidade de títulos 
	cujos códigos de barras dos materiais estão contidos na faixa especificada no filtro de busca.
	</p> 
