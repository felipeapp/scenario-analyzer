...
<f:view>
	<div data-role="page" id="visualizarEmprestimos" data-theme="b">
		<h:form id="formVisualizaEmprestimos">
			...
			<div data-role="content">
				...
				<p align="center"><strong>Meus Empréstimos</strong></p>
				
				<%@include file="/mobile/touch/include/mensagens.jsp"%>
		
				<p><strong><h:outputText value="#{fn:length(operacoesBibliotecaMobileMBean.emprestimosAtivos)} Empréstimo(s) Ativo(s)." /></strong></p>
	
			    <div data-role="collapsible-set" data-content-theme="b">
				    <a4j:repeat var="emprestimo" value="#{ operacoesBibliotecaMobileMBean.emprestimosAtivos }" rowKeyVar="n">
				...
				<c:if test="${not empty acesso.usuario.discente }">
					<script>
						$("#formVisualizaEmprestimos\\:lnkVoltarDiscente").attr("data-icon", "back");
						$("#formVisualizaEmprestimos\\:lnkInicioDiscente").attr("data-icon", "home");
						$("#formVisualizaEmprestimos\\:lnkSair").attr("data-icon", "sair");
					</script>
				</c:if>
			
				<c:if test="${not empty acesso.usuario.servidor }">
					<script>
						$("#formVisualizaEmprestimos\\:lnkVoltarDocente").attr("data-icon", "back");
						$("#formVisualizaEmprestimos\\:lnkInicioDocente").attr("data-icon", "home");
						$("#formVisualizaEmprestimos\\:lnkSair").attr("data-icon", "sair");
					</script>
				</c:if>
			</div>
