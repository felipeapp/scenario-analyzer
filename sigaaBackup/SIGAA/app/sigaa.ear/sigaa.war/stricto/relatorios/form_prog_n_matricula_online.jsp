...
<f:view>
	...
	<h2> <ufrn:subSistema/> > Relatório dos programas que não fizeram matrícula on-line</h2>
	<h:form>
		<table class="formulario" width="35%">
			...
			<tfoot>
				<tr>
					<td colspan="3">
						<h:commandButton value="Gerar Relatório" action="#{relatorioPrograma.relatorioProgramasNFezMatriculaOnline}" /> 
