...
<h2> <ufrn:subSistema /> > Relatório de Cursos por Centro </h2>
<f:view>
  ...
  <h:form id="form">
	<table class="formulario" style="width: 30%" align="center">
		...
		<tfoot>
			<tr>
				<td colspan="3">
					<h:commandButton id="gerarRelatorio" value="Gerar Relatório" action="#{relatoriosLato.cursosCentroSintetico}" /> 
