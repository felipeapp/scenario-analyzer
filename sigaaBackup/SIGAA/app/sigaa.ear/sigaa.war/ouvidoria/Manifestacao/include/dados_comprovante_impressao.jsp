...
<c:if test="${interessadoNaoAutenticado != null }">
	<table class="visualizacao" style="width: 100%;">
		...
		<c:if test="${interessadoNaoAutenticado.enderecoCadastrado }">
			...
			<tr>
				<td style="font-weight: bold; text-align: right;" width="25%">UF: </td>
				...
				<td style="font-weight: bold; text-align: right;" width="25%">Município: </td>
...
<c:if test="${interessado != null }">
	<table class="visualizacao" style="width: 100%">
		...
		<c:if test="${discenteInteressado != null }">
			<tr>
				<th width="25%" style="font-weight: bold; text-align: right;">Matrícula:</th>
				<td style="text-align: left;">
						${discenteInteressado.matricula }
				</td>
			</tr>
			<tr>
				<th width="25%" style="font-weight: bold; text-align: right;">Curso:</th>
				<td style="text-align: left;">
		...
		<c:if test="${servidorInteressado != null }">
			<tr>
				<th width="25%" style="font-weight: bold; text-align: right;">SIAPE:</th>
				<td style="text-align: left;">
						${servidorInteressado.siape }
				</td>
			</tr>
			<tr>
				<th width="25%" style="font-weight: bold; text-align: right;">Lotação:</th>
				<td style="text-align: left;">
...
<table class="visualizacao" style="width: 100%; table-layout: fixed; word-wrap:break-word;">
	<col width="25%">
	<col width="72%">
	<col width="3%">
	<tr>
