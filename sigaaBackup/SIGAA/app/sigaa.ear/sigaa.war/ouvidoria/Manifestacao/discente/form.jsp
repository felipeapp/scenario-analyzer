...
<f:view>
	...
	<div id="ajuda" class="descricaoOperacao">
		<p>Caro aluno, preencha o formulário abaixo com os dados necessários para entrar em contato com a Ouvidoria.</p>
		<p>Após o cadastro de uma manifestação, você pode acompanhá-la através do caminho: </p>
		<p style="left: 5%;">SIGAA -> Portal do Discente -> Outros -> Ouvidoria -> Acompanhar Manifestações.</p>			
	...
	<h:form  enctype="multipart/form-data"  id="formManifestacao">
		<table class="visualizacao" style="width: 90%">
			...
			<tr>
				<td width="14%"></td>
				<th width="3%" style="text-align: right;" nowrap="nowrap">Matrícula:</th>
		...
		<table class="formulario" width="80%">
			...
			<tfoot>
				<tr>
					<td colspan="2">
						<h:commandButton id="btn_notificar" value="Cadastrar Manifestação" action="#{manifestacaoDiscente.cadastrar}" />
