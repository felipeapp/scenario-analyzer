...
<h:form id="form_componentes">
	
	<table class="formulario" width="80%">
		<caption>Internacionalização de Componente(s) do Histórico</caption>
		<thead>
			<tr>
		...
		<tbody>		
			<tr><td colspan="2">
			<c:forEach items="#{historicoTraducaoMBean.mapaComponente}" var="map" varStatus="loop">
		...
		<tr>
			<td colspan=2>
				<h:commandButton value="#{historicoTraducaoMBean.confirmButton}" action="#{historicoTraducaoMBean.cadastrar}" onclick="setAbaHistorico('componentes')"/> 
