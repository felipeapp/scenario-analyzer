...
<f:view>
	<h2> <ufrn:subSistema /> > Secretários de Centro</h2>
	...
	<table class="listagem">
		<caption>Secretários de Centro</caption>
		<thead>
			<tr>
				<th> Departamento </th>
				<th> Secretário(a)</th>
		...
		<tbody>
			<c:forEach var="secretario" items="${ secretariaUnidade.secretariosCentro }" varStatus="loop">
