...
<f:view>
	<h2> <ufrn:subSistema /> > Secretários de Unidade Acadêmica Especializada</h2>
	...
	<table class="listagem">
		<caption>Secretários de Unidade Acadêmica Especializada</caption>
		<thead>
			<tr>
				<th> Departamento </th>
				<th> Secretário(a)</th>
		...
		<tbody>
			<c:forEach var="secretario" items="${ secretariaUnidade.secretariosUnidadeEspecializada }" varStatus="loop">
