...
<table class="listagem" style="width: 80%">
	...
	<tr><td style="text-align: right; font-weight: bold">Título: </td><td colspan="2">${ declaracaoParticipacaoBanca.bancaSelecionada.titulo }</td></tr>
	<tr>
	...
	<c:forEach var="m" items="#{ declaracaoParticipacaoBanca.bancaSelecionada.membrosBanca }" varStatus="loop">
		<tr class="${ loop.index % 2 == 0 ? 'linhaPar' : 'linhaImpar' }">
			...
			<td align="right">
				<h:commandLink action="#{declaracaoParticipacaoBanca.gerarCertificado}" title="Emitir Declaração de Participação em Banca" id="linkGerarCertificado">
