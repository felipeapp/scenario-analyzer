    ...
    <ul>
        <li>Aluno
            <ul>
                ...
                <li> <h:commandLink id="alterarRemoverAluno" action="#{discenteTecnico.atualizar}" value="Alterar/Remover" onclick="setAba('aluno')"/></li>
...
<!--		        <li><h:commandLink id="consultarSolcitacoesMatriculaTecnico" action="#{consultaSolicitacoes.iniciar}" value="Consultar Solicitações de Matrícula" onclick="setAba('aluno')"/> </li>-->
        ...
        <li>Movimentação de Aluno
            <ul>
				...
				<li><h:commandLink id="retornarAlunosTrancadosTecnico" action="#{retornoTrancamento.iniciar }" value="Retornar Alunos de Trancamento" onclick="setAba('aluno')"/> </li>
				...
				<li><h:commandLink id="cancelarAlunoAbondonoTecnico" action="#{jubilamentoMBean.iniciar}"  value="Cancelar Aluno por Abandono"  onclick="setAba('aluno')"/> </li>
            </ul>
		</li>
        <li>Documentos
        	<ul>
