    ...
    <ul>
    	...
    	<li> Operações Administrativas
    		<ul>
	    		...
	    		<li><h:commandLink id="calendarioAcademico" action="#{calendario.iniciarTecnico}" value="Calendário" onclick="setAba('curso')"/> </li>
	    		<li><h:commandLink id="parametrosGestoraAcademica" action="#{parametros.iniciarTecnico}" value="Parâmetros" onclick="setAba('curso')"/> </li>
    		</ul>
    	</li>
    </ul>