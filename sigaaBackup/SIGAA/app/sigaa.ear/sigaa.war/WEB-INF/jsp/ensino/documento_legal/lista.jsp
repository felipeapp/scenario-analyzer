...
<html:form action="/ensino/cadastroDocumentoLegal?dispatch=list" method="post">
...
<caption>Busca por Documentos Legais</caption>
	...
	<td><html:text property="obj.nomeDocumento" size="30" onkeyup="CAPS(this)" onfocus="javascript:forms[0].tipoBusca[0].checked = true;"/></td>
	</tr>
    ...
    <td><html:text property="obj.nroDocumento" size="30" maxlength="20" onkeyup="CAPS(this)" onfocus="javascript:forms[0].tipoBusca[1].checked = true;"/></td>
	</tr>
