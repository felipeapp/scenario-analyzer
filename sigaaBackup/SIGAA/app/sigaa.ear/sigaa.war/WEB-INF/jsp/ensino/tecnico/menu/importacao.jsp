<ul>
	<ufrn:checkRole	papeis="<%= new int[] { SigaaPapeis.GESTOR_IMPORTACAO_PROCESSO_SELETIVO_TECNICO } %>">
	 	...
	 	<li>Importação
			<ul>
				<li><h:commandLink action="#{importaAprovadosTecnicoMBean.iniciarDefinicaoLeiaute}" value="Definir Leiaute do Arquivo de Importação" onclick="setAba('importacao')" id="importaInscricaoTecnicoMBean_iniciarDefinicaoLeiaute"/></li>
				<li><h:commandLink action="#{importaAprovadosTecnicoMBean.listarLeiautes}" value="Listar Leiautes do Arquivo de Importação" onclick="setAba('importacao')" id="importaInscricaoTecnicoMBean_listarLeiautes"/></li>
	...
	<ufrn:checkRole	papeis="<%= new int[] { SigaaPapeis.GESTOR_IMPORTACAO_PROCESSO_SELETIVO_TECNICO, SigaaPapeis.GESTOR_CONVOCACAO_PROCESSO_SELETIVO_TECNICO, SigaaPapeis.GESTOR_CADASTRAMENTO_PROCESSO_SELETIVO_TECNICO } %>"> 	
		<li>Cadastramento
	 		...
	 		<ul>
				...
				<%--<li><h:commandLink action="#{cadastramentoDiscenteTecnico.relatorioQuantitativoConvocadosCadastrados}" value="Relatório Quantitativo de discentes Convocados X Cadastrados" onclick="setAba('importacao')" id="cadastramentoDiscenteTecnico_relatorioQuantitativo"/></li>--%>
	 		</ul>
	 	</li>
	</ufrn:checkRole>
