...
<div class="descricaoOperacao">
	<p>
		Caro gestor, através desta operação serão distribuídos os projetos marcados como INTERNOS e que aguardam avaliação para
		os consultores externos cadastrados na base de dados.
	</p>
</div>
...
<caption>Filtrar projetos por edital</caption>
	...
	<tfoot>
	<tr>
		<td colspan="2"> <html:button dispatch="popularAutomatica" value="Filtrar Projetos"/></td>
	</tr>
</table>
<br />
...
<c:if test="${not empty areas}">
	<table id="distribuicao" class="listagem">
		...
		<tfoot>
			...
			<tr>
				<td colspan="3">
					<html:button dispatch="automaticamente" value="Realizar Distribuição"/>
