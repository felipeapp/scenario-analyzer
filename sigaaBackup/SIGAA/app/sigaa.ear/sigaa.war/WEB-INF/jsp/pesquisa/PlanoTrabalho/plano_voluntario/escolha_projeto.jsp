...
<h2> <ufrn:subSistema /> &gt; Cadastro de Plano de Trabalho Voluntário &gt; Escolha do Projeto </h2>
...
<div class="descricaoOperacao">
	<p>
		...
		Se o projeto desejado não está listado abaixo, verifique se ele possui as seguintes características:
		<ul>
			<li> Está sob sua coordenação; </li>
			<li> Possui status SUBMETIDO ou EM EXECUÇÃO; </li>
			<li> Possui período compatível com o período de vigência da cota selecionada. </li>
		</ul>
	</p>
</div>
