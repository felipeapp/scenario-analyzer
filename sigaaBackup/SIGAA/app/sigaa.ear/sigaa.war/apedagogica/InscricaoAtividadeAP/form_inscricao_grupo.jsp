...
<f:view>
	...
	<h2 class="title"><ufrn:subSistema />  > Inscrição para Participação em Atividade > Seleção de Grupo de Atividade</h2>

	<h:form id="formBuscaParticipante" prependId="true">

		<div class="descricaoOperacao">
			<p>Caro usuário,</p>
			<p>A listagem abaixo exibe todos os grupos de atividades pedagógicas abertos.</p>
		...
		<t:dataTable value="#{grupoAtividadesAP.allAbertos}" rendered="#{not empty grupoAtividadesAP.allAbertos}"
			 ...
			 columnClasses="colDocente,colIcone" rowClasses="linhaPar, linhaImpar">
					...
					<t:column styleClass="colPeriodo" headerstyleClass="colPeriodo">
						...
						<h:outputText value="#{_g.inicioInscricao}"/> a
					...
					<t:column styleClass="colPeriodo" headerstyleClass="colPeriodo">
						...
						<h:outputText value="#{_g.inicio}"/> a
					...
					<t:column styleClass="colIcone" headerstyleClass="colIcone">
						...
						<h:commandLink action="#{inscricaoAtividadeAP.selecionarGrupo}"
					...
					<f:facet name="footer">
						<h:commandButton value="<< Voltar" action="#{inscricaoAtividadeAP.preCadastrarGestor}" 
