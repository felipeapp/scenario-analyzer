		...
		<table class="formulario" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td colspan="2">
						<t:selectManyCheckbox value="#{solicitacaoApoioNee.tiposNecessidadesEspeciaisSelecionadas}" id="opcaoTipo" layout="pageDirection" layoutWidth="4">
				...
				<tr>
					...
					<td colspan="5">
						<h:selectOneRadio value="#{solicitacaoApoioNee.obj.parecerAtivo}" id="opcaoParecerAtivo" layout="pageDirection" rendered="#{solicitacaoApoioNee.parecerNee}">
				...
				<tr>
					...
					<td colspan="5">
						<t:selectOneRadio value="#{solicitacaoApoioNee.obj.statusAtendimento.id}" id="opcaoStatus" layout="lineDirection" rendered="#{solicitacaoApoioNee.parecerNee}">
				...
				<tr>
					<th colspan="1">
						<h:outputText value="Justificativa para solicitação de apoio a CAENE:" rendered="#{!solicitacaoApoioNee.parecerNee}" styleClass="obrigatorio" style="font-weight: normal;"/>
						<h:outputText value="Justificativa para Solicitação de Apoio a CAENE:" rendered="#{solicitacaoApoioNee.parecerNee}" />
					</th>
					<td colspan="3">
			...
			<tfoot>
				<tr>
					<td colspan="4">
						<h:commandButton value="#{solicitacaoApoioNee.confirmButton}" action="#{solicitacaoApoioNee.cadastrar}" /> 
						<input type="button" value="<< Voltar"  onclick="javascript: history.back();" id="voltar" />
						<h:commandButton value="Cancelar" onclick="#{confirm}" action="#{solicitacaoApoioNee.cancelar}" />
					</td>
				</tr>
			</tfoot>
		</table>
