	...
	<table width="100%">
		<tr>
			<td width="40%">
				<ul>
					<li>
						Serão financiáveis os elementos de despesa, desde que 
						os dispêndios estejam comprovados e estritamente vinculados  
						à execução do projeto, e sustentados nas definições metodológicas 
						da proposta.
						<br/>
					</li>
					<li>
	...
	<h:form id="form">
		<table class="formulario" width="90%" >
			...
			<tr>
				<td colspan="5" >
					...
					<ul class="nav" style="margin-left:15%">
							...
							<li><a href="#nb" id="32" onclick="checkTipoDespesa('32');"><img src="${ctx}/img/extensao/financiamento_faex.png" /><br/>Obrigações Contributivas</a></li>
					</ul>
				</td>
			</tr>
			...
			<tr>
				...
				<td colspan="5">
					<h:inputTextarea id="discriminacao" value="#{projetoMonitoria.orcamento.discriminacao}" style="width: 95%" rows="2"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td width="10%">
					<h:inputText id="quantidade" value="#{projetoMonitoria.orcamento.quantidade}" 
				...
				<td>
					<h:inputText id="valorUnitario" value="#{projetoMonitoria.orcamento.valorUnitario}" size="22" maxlength="14" 
                ...
                <td>
                    ...
                    <h:selectBooleanCheckbox id="checkMaterialLicitado" value="#{projetoMonitoria.orcamento.materialLicitado}" label="Material Licitado" />
			...
			<tfoot>
				<tr>
					...
					<h:commandButton	action="#{projetoMonitoria.adicionaOrcamento}" value="Adicionar Despesa"/>
					</td>
				</tr>
			</tfoot>
		</table>
						...
						<table class="listagem">
								...
								<tbody>
									...
									<c:if test="${not empty projetoMonitoria.tabelaOrcamentaria}">
														...
														<c:forEach items="#{orcas}" var="orca" varStatus="status">
															<tr class="${status.index % 2 == 0 ? "linhaPar" : "linhaImpar" }">
																...
																<td width="5%" align="right">
																	<h:commandLink action="#{projetoMonitoria.removeOrcamento}" title="Remover Despesa" onclick="return confirm('Deseja remover esta despesa?');" immediate="true" id="bt_remover_orcamento">
																		<f:param name="idOrcamentoDetalhado" value="#{orca.id}"/>
																		<f:param name="posicao" value="#{orca.posicao}"/>
										...
										<c:if test="${empty projetoMonitoria.tabelaOrcamentaria}">
			...
			<table class="formulario" width="100%">
						<tfoot>
							<tr>
								<td colspan="2">
								<h:form>
									<h:commandButton value="Gravar Proposta" action="#{ projetoMonitoria.cadastrarParcialOrcamento }" title="Gravar Proposta para Continuar Depois." id="btGravar" />
									<h:commandButton value="<< Voltar" action="#{projetoMonitoria.passoAnterior}" id="voltar"/>
									<h:commandButton value="Cancelar" action="#{projetoMonitoria.cancelar}" id="cancelar"  onclick="#{confirm}"/>
									<h:commandButton value="Avançar >>" action="#{projetoMonitoria.submeterOrcamentoDetalhado}" id="avancar"/>
								</h:form>
								</td>
							</tr>
						</tfoot>
