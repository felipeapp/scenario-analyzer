...
<f:view>
	...
	<h:form id="form">
			<table class="formulario">
				<caption><h:outputText value="#{relatorioMonitor.obj.tipoRelatorio.descricao}"/> DE MONITORIA</caption>
			...
			<tr>
				...
				<h:outputText
					...
					${relatorioMonitor.obj.oportunidadeConhecerProjeto}
				</td>
			</tr>
			...
			<tr>
				<td align="justify"><b>Parecer da Coordenação do Projeto:</b><br/>
					<h:outputText	value="#{relatorioMonitor.obj.coordenacaoValidouDesligamento == true ? 'Validado' : 'Não Validado'}"	id="txtCoordValidouDesligamento"/>
				</td>
			</tr>

			<tr>
				<td><b>Observações da Coordenação:</b> <br/>
					<h:outputText id="txtCoordObservacoes"	value="#{relatorioMonitor.obj.observacaoCoordenacaoDesligamento}"/>
				</td>
			</tr>			
			...
			<tr>
				<td align="justify"><b>Parecer da PROGRAD:</b>
				<h:selectOneRadio
					value="#{relatorioMonitor.obj.progradValidouDesligamento}"	id="cmbProgradValidouDesligamento">
			...
			<tr>
				...
				<h:inputTextarea id="txtObservacoes"
					value="#{relatorioMonitor.obj.observacaoProgradDesligamento}"
			...
			<tfoot>
				<tr>
					<td colspan="2">
						<h:commandButton id="btConfirmar" value="Confirmar Parecer" action="#{relatorioMonitor.progradValidarRelatorioDesligamento}" />
						<input type="button" value="Imprimir" onclick="javascript:window.print()"/>
						<h:commandButton id="btnCancelar" value="Cancelar" action="#{relatorioMonitor.cancelar}" onclick="#{confirm}"/>						
					</td>
				</tr>
			</tfoot>
		</table>
