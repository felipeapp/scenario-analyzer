			        ...
			        <tbody>
				          	<c:forEach items="#{lista}" var="prova" varStatus="status">
					               <tr class="${ status.index % 2 == 0 ? "linhaPar" : "linhaImpar" }">
					                    ...
					                    <td width="15%"><fmt:formatDate pattern="dd/MM/yyyy" value="${prova.dataLimiteIncricao}" /></td>


										<td width="2%">	
												<h:commandLink  title="Ver Detalhes do Projeto" action="#{projetoMonitoria.view}" 
												style="border: 0;">
