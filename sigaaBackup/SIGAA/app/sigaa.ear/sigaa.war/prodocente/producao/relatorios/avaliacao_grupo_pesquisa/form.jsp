...
<f:view>
	...
	<h:form id="form">
		...
		<table class="formulario" width="600">
			...
			<tbody>
				<tr>
					<td> Grupo de Pesquisa: </td>
					<td>
						<h:selectOneMenu id="grupo" value="#{relatorioAvaliacaoGrupoPesquisaMBean.grupo.id}" style="width: 95%">
							<f:selectItem itemLabel="-- SELECIONE -- " itemValue="0"/>
							<f:selectItems value="#{grupoPesquisa.allCombo}" />
						</h:selectOneMenu>
					</td>
				</tr>
				<tr>
			...
			<tfoot>
				<tr>
					<td colspan="2">
						<h:commandButton value="Gerar Relatório" action="#{relatorioAvaliacaoGrupoPesquisaMBean.gerarRelatorio}" />
