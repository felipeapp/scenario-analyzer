...
<f:view>
	...
	<h:form>
		<div class="infoAltRem">
			 <h:graphicImage value="/img/adicionar.gif"style="overflow: visible;"/><h:commandLink action="#{premioRecebido.preCadastrar}" value="Cadastrar Prêmio Recebido"/><h:graphicImage value="/img/alterar.gif"style="overflow: visible;"/>: Alterar
...
<c:if test="${empty lista}">
	<br />
	<center>
	<span style="color:red;">Nenhum Prêmio Recebido Encontrado.</span>
	</center>
</c:if>
<c:if test="${not empty lista}">
	...
	<table class=listagem style="width:100%">
		<caption class="listagem">Lista de Prêmio Recebido</caption>
		<thead>
			<tr>
			<td></td>
			<td>Prêmio</td>
