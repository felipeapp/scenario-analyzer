...
<f:view>
	...
	<hr>
		...
		<h:commandLink action="#{tipoAvaliacaoOrganizacaoEvento.listar}"
			value="Listar Tipo de Avaliação de Organização de Evento Cadastradas"/>
		</div>
	</h:form>
	...
	<h:form id="form">
		<table class=formulario width="90%">
			...
			<tr>
				...
				<td><h:inputText
					value="#{tipoAvaliacaoOrganizacaoEvento.obj.descricao}" size="80"
					maxlength="255"
