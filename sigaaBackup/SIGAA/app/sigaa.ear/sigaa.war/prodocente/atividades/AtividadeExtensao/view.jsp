			...
			<tfoot>
				<tr>
					<td colspan=2><h:commandButton
						value="#{atividadeExtensaoProdocente.confirmButton}"
						action="#{atividadeExtensaoProdocente.cadastrar}" /> <h:commandButton
						value="Cancelar" action="#{atividadeExtensaoProdocente.cancelar}" /></td>
				</tr>
			</tfoot>
		</table>
	</h:form>
