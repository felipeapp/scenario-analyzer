...
<f:view>
	...
	<h:form id="form">
		<table class=formulario width="90%">
			...
			<tr>
				<th class="required">Alunos:</th>
				<td><h:inputText value="#{orientacaoProex.obj.alunos}"
					size="60" maxlength="255" readonly="#{orientacaoProex.readOnly}"
					id="alunos" /></td>
			</tr>
			<tr>
				...
				<td><t:inputCalendar
							value="#{orientacaoProex.obj.dataInicio}" size="10"
			...
			<tr>
				...
				<td><t:inputCalendar
							value="#{orientacaoProex.obj.dataFinal}" size="10"
							maxlength="10" readonly="#{orientacao.readOnly}" id="dataFinal"
							renderAsPopup="true" renderPopupButtonAsImage="true" /></td>
			<tr>
			...
			<tfoot>
				<tr>
					<td colspan=2><h:commandButton
						...
						value="Cancelar" action="#{orientacaoProex.cancelar}" /></td>
				</tr>
			</tfoot>
		</table>
	</h:form>
