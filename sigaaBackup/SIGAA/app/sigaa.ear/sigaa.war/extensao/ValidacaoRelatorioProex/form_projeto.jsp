...
<f:view>
	<h2><ufrn:subSistema /> &gt; Validação de Relatório de Projeto</h2>

	<h:form prependId="false">
		
		<table class="formulario" width="100%">
			<caption class="listagem">Validação de Relatório de Projetos de Extensão</caption>	
		
			<tr>
				<td colspan="2">
					<b> Código Projeto:</b><br />
			...
			<tr>
				<td colspan="2" align="justify"> 
					<b>Relação entre a proposta pedagógica do curso e a proposta do projeto de extensão? Justifique:</b><br />
			...
			<tr>	
				<td colspan="2">
					<b>Outras ações realizadas vinculadas ao projeto:</b><br />
			...
			<tr>	
				<td colspan="2">
					<b>Apresentação do projeto em eventos de extensão:</b><br />
			...
			<tr>	
				<td colspan="2">
					<b> Produção acadêmica gerada:</b><br />
			...
			<tr>
				<td colspan="2" align="justify">
					<b> Resultados Obtidos: Qualitativos.</b><br />
			...
			<tr>
				<td colspan="2" align="justify">
					<b> Resultados Obtidos: Quantitativos.</b><br />
			...
			<tr>
				<td colspan="2" align="justify">
					<b> Dificuldades Encontradas:</b><br />
			...
			<tr>
				...
				<td>	
					<h:selectOneMenu id="tipoParecerProex" value="#{relatorioAcaoExtensao.obj.tipoParecerProex.id}" style="width: 30%;"
			...
			<tr>			
				...
				<td>
					<h:inputTextarea id="parecerProex" value="#{relatorioAcaoExtensao.obj.parecerProex}" rows="5" style="width: 98%" />
				</td>
			</tr>
