	...
	<h:form id="form1">
		...
		<table class="formulario" width="90%">
			...
			<tbody>			
				...
				<tr>
					<th class="required"> Mini Atividade:</th>
					<td>
						<b><h:outputText value="#{inscricaoAtividade.obj.subAtividade.titulo}"/></b>						
					</td>
				</tr>
				
				<tr>
					<th class="required"> Método de Preenchimento das vagas:</th>
					<td>
						<h:selectOneMenu id="metodoPreenchimento"	value="#{inscricaoAtividade.obj.metodoPreenchimento}" style="width: 70%;">
							<f:selectItem itemValue="0" itemLabel="-- SELECIONE O MÉTODO DE PREENCHIMENTO --"/>
							<f:selectItems value="#{inscricaoAtividade.allMetodosPreenchimento}"/>
						</h:selectOneMenu>
					</td>
				</tr>
			...
			<tfoot>
				<tr>
					<td colspan="2">
						<h:commandButton value="#{inscricaoAtividade.confirmButton}" action="#{inscricaoAtividade.cadastrarInscricaoSubAtividade}" id="cadastrar" />
