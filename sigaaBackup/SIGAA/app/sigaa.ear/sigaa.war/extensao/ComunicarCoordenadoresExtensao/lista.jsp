				...
				<tr>
					<td>
						<h:panelGroup id="listaCheckbox">
							<rich:dataTable var="acao" value="#{atividadeExtensao.atividadesLocalizadas}" 
								...
								<rich:column>
									...
									<center><h:selectBooleanCheckbox id="checkSelecionada" value="#{acao.projeto.selecionado}"/></center>
								</rich:column>
								...
								<rich:column>
									...
									<h:outputText value="<br/><i>Coordenador(a): #{acao.coordenacao.pessoa.nome}</i>" rendered="#{not empty acao.coordenacao}" escape="false"/>
								</rich:column>
				...
				<tfoot>
					<tr>
						<td align="center" colspan="5">
							<h:commandButton value="Próximo passo >>" action="#{comunicarCoordenadores.comunicarCoordenadoresExtensao}" />
						</td>
					</tr>
				</tfoot>
			</table>
