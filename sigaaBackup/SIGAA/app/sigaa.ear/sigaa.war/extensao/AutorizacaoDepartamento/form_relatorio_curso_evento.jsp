...
<f:view>
	...
	<h:form prependId="false">
		...
		<caption class="listagem">Validação de Relatório de Cursos e Eventos de Extensão</caption>	
			...
			<tr>
				<th><b>Cobrança de Taxa</b></th>
				<td>R$ <h:outputText value="#{autorizacaoDepartamento.relatorio.taxaMatricula}"	id="cobrancaTaxa"/></td>
			</tr>
			
			
			<tr>
				<th><b>Valor Arrecadado:</b></th>
				<td>R$ <h:outputText value="#{autorizacaoDepartamento.relatorio.totalArrecadado}"	id="valorArrecadado"/></td>
			</tr>
			...
			<tr>
				...
				<td>
					<h:outputText value="#{autorizacaoDepartamento.relatorio.numeroConcluintes}" id="numeroConcluintes"/>
				</td>	
			</tr>
