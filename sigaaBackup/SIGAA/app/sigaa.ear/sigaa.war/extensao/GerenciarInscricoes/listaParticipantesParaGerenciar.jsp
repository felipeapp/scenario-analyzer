	...
	<h2><ufrn:subSistema /> &gt; Gerenciar Participantes  &gt; Lista de Participantes </h2>
		...
		<h:form id="formListaParticipantesGerenciar">
			...
			<table class="formulario" style="margin-bottom: 20px; width: 70%;">
				...
				<tr>
					<td>
						<h:selectBooleanCheckbox value="#{gerenciarParticipantesExtensaoMBean.checkBuscaNome}"  id="checkBuscaNome" styleClass="checkNaoMarcar"  />
					</td>
					<td>Nome:</td>
					<td colspan="2"> 
						<h:inputText id="nome" value="#{ gerenciarParticipantesExtensaoMBean.buscaNome }" size="60"  maxlength="60"
				...
				<tr>
					<td>
						<h:selectBooleanCheckbox value="#{gerenciarParticipantesExtensaoMBean.checkBuscaMunicipio}"  id="checkBuscaMunicipio" styleClass="checkNaoMarcar" />
					</td>
					<td>UF:</td>
					<td colspan="2">
						<table>		
							<tr>
								<td style="padding: 0px;">
									<h:selectOneMenu value="#{gerenciarParticipantesExtensaoMBean.idUnidadeFederativa}" id="uf" immediate="true">
										<f:selectItem itemLabel="-- Selecione -- " itemValue="-1" />
										<f:selectItems value="#{unidadeFederativa.allCombo}" />
										<a4j:support event="onchange" reRender="municipio" action="#{gerenciarParticipantesExtensaoMBean.carregarMunicipios}"/>
									</h:selectOneMenu>
								</td>
								<td>Município:</td>
								<td>
									<h:selectOneMenu value="#{gerenciarParticipantesExtensaoMBean.idMunicipio}" id="municipio" 
										...
										<f:selectItem itemLabel="-- Selecione -- " itemValue="-1" />
										<f:selectItems value="#{gerenciarParticipantesExtensaoMBean.municipiosComBox}" />
									</h:selectOneMenu>
								</td>
							<tr>
						</table>
				...
				<tr>
					<td width="2%">
						<h:selectBooleanCheckbox value="#{gerenciarParticipantesExtensaoMBean.participantesSemFrequencia}" styleClass="checkNaoMarcar" id="checkFiltraSemFrequencia"/>
					</td>
				...
				<tr>
					<td width="2%">
						<h:selectBooleanCheckbox value="#{gerenciarParticipantesExtensaoMBean.participantesNaoDeclaracao}" styleClass="checkNaoMarcar" id="checkFiltraNaoDeclaracao"/>
					</td>
				...
				<tr>
					<td width="2%">
						<h:selectBooleanCheckbox value="#{gerenciarParticipantesExtensaoMBean.participantesNaoCertificados}" styleClass="checkNaoMarcar" id="checkFiltraNaoCertificado"/>
					</td>
				...
				<tr>
					...
					<td colspan="3">
						<h:selectOneMenu value="#{gerenciarParticipantesExtensaoMBean.tamanhoPagina}">
				...
				<tfoot>
					<tr>
						<td colspan="4">
							<h:commandButton value="Filtrar" action="#{gerenciarParticipantesExtensaoMBean.filtarParticipantesAtividade}" /> 
						</td>
					</tr>
				</tfoot>
			</table>
			...
			<c:if test="${gerenciarParticipantesExtensaoMBean.gerenciandoParticipantesAtividade}">
				<table class="visualizacao" style="width: 80%; margin-bottom: 20px;">
					...
					<tr>
						<th>Código:</th>
						<td><h:outputText value="#{gerenciarParticipantesExtensaoMBean.atividadeSelecionada.codigo}" /></td>
					</tr>
					<tr>
						<th>Atividade:</th>
						<td><h:outputText value="#{gerenciarParticipantesExtensaoMBean.atividadeSelecionada.titulo}" /></td>
					</tr>
					<tr>
						<th>Coordenação:</th>
						<td><h:outputText value="#{gerenciarParticipantesExtensaoMBean.atividadeSelecionada.projeto.coordenador.pessoa.nome}" /></td>
					</tr>
					<tr>
						<th>Período:</th>
						<td><h:outputText value="#{gerenciarParticipantesExtensaoMBean.atividadeSelecionada.dataInicio}" > 
								<f:convertDateTime pattern="dd/MM/yyyy" />
							</h:outputText> 
							até 
							<h:outputText value="#{gerenciarParticipantesExtensaoMBean.atividadeSelecionada.dataFim}" >
								<f:convertDateTime pattern="dd/MM/yyyy" />
							</h:outputText> 
						</td>
					</tr>
			...
			<c:if test="${! gerenciarParticipantesExtensaoMBean.gerenciandoParticipantesAtividade}">
				<table class="visualizacao" style="width: 80%; margin-bottom: 20px;">
					...
					<tr>
						<th>Código:</th>
						<td><h:outputText value="#{gerenciarParticipantesExtensaoMBean.subatividadeSelecionada.atividade.codigo}" /></td>
					</tr>
					<tr>
						<th>Atividade:</th>
						<td><h:outputText value="#{gerenciarParticipantesExtensaoMBean.subatividadeSelecionada.atividade.titulo}"  /></td>
					</tr>
					<tr>
						<th>Mini Atividade:</th>
						<td><h:outputText value="#{gerenciarParticipantesExtensaoMBean.subatividadeSelecionada.titulo}"  /></td>
					</tr>
					<tr>
						<th>Coordenação:</th>
						<td><h:outputText value="#{gerenciarParticipantesExtensaoMBean.subatividadeSelecionada.atividade.projeto.coordenador.pessoa.nome}" /></td>
					</tr>
					<tr>
						<th>Período:</th>
						<td><h:outputText value="#{gerenciarParticipantesExtensaoMBean.subatividadeSelecionada.inicio}" > 
								<f:convertDateTime pattern="dd/MM/yyyy" />
							</h:outputText> 
							até 
							<h:outputText value="#{gerenciarParticipantesExtensaoMBean.subatividadeSelecionada.fim}" >
								<f:convertDateTime pattern="dd/MM/yyyy" />
							</h:outputText> 
						</td>
					</tr>
			...
			<rich:contextMenu attached="false" id="menuOpcoesParticipantes" hideDelay="300" >
		        ...
		        <rich:menuItem value="Notificar Participante" icon="/img/email_go.png" action="#{gerenciarParticipantesExtensaoMBean.preNotificarParticipante}">	
						<f:param name="idCadastroParticipante" value="{_id_cadastro_participante_context_menu}"/>		
		        </rich:menuItem>
		        
		        <rich:menuItem value="Alterar Participante" icon="/img/extensao/user1_refresh.png" action="#{gerenciarParticipantesExtensaoMBean.preAlterarParticipante}">	
						<f:param name="idParticipante" value="{_id_participante_context_menu}"/>		
		        </rich:menuItem>
		        
		        <rich:menuItem value="Remover Participante" icon="/img/extensao/user1_delete.png" action="#{gerenciarParticipantesExtensaoMBean.preRemoverParticipanteAtividade}">	
						<f:param name="idParticipante" value="{_id_participante_context_menu}"/>		
		        </rich:menuItem>
			...
			<div class="infoAltRem">
				...
				<h:commandLink value="Adicionar Novo Participante" action="#{gerenciarParticipantesExtensaoMBean.preCadastrarNovoParticipante}" />
			...
			<div style="text-align: center;">
				<h:commandButton image="/img/voltar.gif"
				 	action="#{gerenciarParticipantesExtensaoMBean.previousPage}"
					rendered="#{gerenciarParticipantesExtensaoMBean.paginaAtual > 0 }"
					style="vertical-align:middle" id="paginacaoVoltarHeader" >
				</h:commandButton> 
					
				<b><h:outputText value="#{gerenciarParticipantesExtensaoMBean.paginaAtual +1} de #{gerenciarParticipantesExtensaoMBean.totalPaginas}"></h:outputText></b>
				
				<h:commandButton image="/img/avancar.gif"
						action="#{gerenciarParticipantesExtensaoMBean.nextPage}"
						rendered="#{gerenciarParticipantesExtensaoMBean.paginaAtual < (gerenciarParticipantesExtensaoMBean.totalPaginas - 1)}"
			...
			<table id="tabelaAtividades"  class="listagem" style="width: 100%;">
					...
					<tbody>
						...
						<c:if test="${gerenciarParticipantesExtensaoMBean.qtdParticipantes > 0 }">
							
							<c:forEach items="#{gerenciarParticipantesExtensaoMBean.participantes}" var="participante" varStatus="count">
				...
				<tfoot>
					<tr>
						<td align="center" colspan="12">
							<h:commandButton value="Salvar Alterações" id="btnConfirmarAlteracoes" actionListener="#{gerenciarParticipantesExtensaoMBean.atualizarInformacoesEmtirDeclaracoesParticipantes}" />
							<h:commandButton value="Cancelar" action="#{listaAtividadesParticipantesExtensaoMBean.telaListaAtividadeParaGerenciarParticipantes}" immediate="true" /> 
						</td>
					</tr>
				</tfoot>
			...
			<div style="text-align: center;">
				...
				<br />
				<br />
				<em><h:outputText value="#{gerenciarParticipantesExtensaoMBean.totalRegistros }" /> Registro(s) Encontrado(s)</em>
			</div>
