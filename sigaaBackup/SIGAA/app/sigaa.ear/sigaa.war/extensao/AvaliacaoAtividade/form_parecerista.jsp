	...
	<a4j:outputPanel id="tabelaNotas">
		<table class="formulario" width="100%">
			<caption>Avaliar Projeto de Extensão</caption>				
				...
				<tr>
					<td style="text-align: center;" class="subFormulario"> A ação de Extensão atende os critério? &nbsp;
						<h:selectBooleanCheckbox value="#{ avaliacaoAtividade.obj.atendeCriterios }" id="chkCriteriosAva">
							<a4j:support reRender="formAvaliacaoAtividade" 
								actionListener="#{avaliacaoAtividade.criteriosAvaliacao}" event="onchange" />
						</h:selectBooleanCheckbox>
					</td>
				</tr>	
			
				<a4j:region id="criteriosAvaliacao" rendered="#{ avaliacaoAtividade.obj.atendeCriterios }">
					<tr>
						<td colspan="2">						
							<h:dataTable id="_avaliacao" value="#{avaliacaoAtividade.obj.notasItem}" var="nota" width="100%" styleClass="listagem" 
								rowClasses="linhaPar, linhaImpar" binding="#{avaliacaoAtividade.htmlDataTable}">
				...
				<tr>
					<td>
						<br />  
						Parecer: 
						<h:selectOneRadio id="rbParecer" value="#{avaliacaoAtividade.obj.parecer.id}" disabled="#{ not avaliacaoAtividade.obj.atendeCriterios }">
