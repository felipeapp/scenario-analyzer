...
%>
${portalPublicoPrograma.iniciar}
<c:set var="ctx" value="<%= request.getContextPath() %>"/>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Portal de Programas de Pós-Graduação (${ configSistema['siglaInstituicao'] })</title>
    <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
    <meta name="author" content="Andressa Kroeff Pires - SINFO">
    <link rev=made href="mailto:andressa@info.ufrn.br">
    <link rel="stylesheet" href="${ctx}/public/programa/css/template.css" />
    <%@ include file="../css/programa.css.jsp" %>
</head>
<body>
	<div id="bg">
    	<div id="bg_rodape">
