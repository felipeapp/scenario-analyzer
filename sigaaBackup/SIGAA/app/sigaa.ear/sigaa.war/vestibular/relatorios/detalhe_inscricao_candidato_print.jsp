...
<f:view>
		...
		<table class="tabelaRelatorioBorda" width="95%">
			...
			<tbody>
				...
				<tr>
					...
					<th class="rotulo" colspan="2">Data de Nascimento:</th>
					<td><t:outputText
				...
				<tr>
					<th class="rotulo" colspan="2">Tipo de Necessidade Especial:</th>
					<td colspan="4">
				...
				<tr>
					<th class="rotulo" colspan="2">Escola de Conclusão do EM:</th>
					<td colspan="4">
						<h:outputText value="#{relatoriosVestibular.inscricao.pessoa.nomeEscolaConclusaoEnsinoMedio}" />
					</td>
				</tr>
				<tr>
					<th class="rotulo" colspan="2">Ano de Conclusão:</th>
					<td colspan="4"><h:outputText
				...
				<tr>
					<th class="rotulo" colspan="2">Nº do Doc. de Identificação:</th>
					<td><h:outputText
						value="#{relatoriosVestibular.inscricao.pessoa.identidade.numero}" /></td>
					<th class="rotulo" colspan="2">Órgão de Expedição:</th>
					<td><h:outputText
				...
				<tr>
					...
					<th class="rotulo" colspan="2">Data de Expedição:</th>
					<td><t:outputText
				...
				<tr>
					<th class="rotulo" colspan="2"> Nº do Certificado Militar:</th>
			...
			<tbody>
				...
				<tr>
					...
					- <h:outputText value="#{relatoriosVestibular.inscricao.opcoesCurso[0]}" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="5"><h:outputText value="#{relatoriosVestibular.inscricao.regiaoPreferencialProva.denominacao}" /></td>
				</tr>
				<tr>
					<th><b>Situação da Inscrição:</b></th>
					<td colspan="5">
						<c:choose>
