...
<f:view>
	...
	<h:form>
		...
		<h2> <ufrn:subSistema /> > Discussão sobre ${forumMensagem.tituloCursoDiscutidoAtualmente} </h2>	
			...
			<c:forEach items="#{forumMensagem.listaForumMensagens}" var="item" varStatus="loop">
				...
				<tr style="background-color: #C4D2EB">	
					...
					<ufrn:checkRole papeis="<%= new int[] { SigaaPapeis.COORDENADOR_CURSO } %>">
						<h:commandLink value="Emitir Histórico" action="#{forumMensagem.emitirHistoricoAluno}" id="emitirHistorico" 
