...
<div class="descricaoOperacao">
	<p>Caro Usuário,</p>
		<p>
			Esta operação processará todas as convocações de candidatos com
			status <b>PRÉ-CADASTRADO</b> cancelando sua convocação e encerrando definitivamente o cadastramento de discentes.
		</p>
	</div>
