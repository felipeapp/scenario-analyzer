...
<div align="center">
	 <a4j:outputPanel id="progressPanel">
		<rich:progressBar interval="500" id="progressBar" minValue="0" maxValue="100" mode="ajax"
											...
											<c:forEach items="#{convocacaoVagasRemanescentesVestibularMBean.convocacoes}" var="conv" varStatus="loop">
												<c:if test="${_matriz_loop != conv.discente.matrizCurricular.id}">
													...
													<tr>
														...
														<h:outputText value="#{conv.discente.matrizCurricular.id}"/> -  
						...
						<tfoot>
							<tr>
								<td colspan="2" style="text-align: center;">
									...
									<h:commandButton value="<< Voltar" action="#{ convocacaoVagasRemanescentesVestibularMBean.telaFormulario }" id="btnVoltar"/>
