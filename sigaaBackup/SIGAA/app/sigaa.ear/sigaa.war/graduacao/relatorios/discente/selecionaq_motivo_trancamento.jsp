...
<h2><ufrn:subSistema /> > Relatório Quantitativo de Solicitação de Trancamento</h2>
...
<table align="center" class="formulario" width="100%">
	...
	<tr>
		...
		<td><label for="form:checkAnoPeriodo">Ano-Semestre:</label></td>
	...
	<tr>
		...
		<td><label for="form:checkMotivoTrancamento">Motivo de Trancamento:</label></td>
	...
	<tr>
		<td colspan="3" align="center">
						...
						action="#{relatorioDiscente.gerarRelatorioQuantitativosAlunoMotivoTrancamento}"/> <h:commandButton
