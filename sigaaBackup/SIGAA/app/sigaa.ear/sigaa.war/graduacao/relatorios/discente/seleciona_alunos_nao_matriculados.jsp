...
<h2> <ufrn:subSistema/> > Relatório de Alunos Ativos não Matriculados </h2>
	...
	<tfoot>
		<tr>
			<td colspan="3" align="center">
							...
							action="#{relatorioDiscente.gerarRelatorioAlunosAtivosNaoMatriculadosBolsa}"/> <h:commandButton
