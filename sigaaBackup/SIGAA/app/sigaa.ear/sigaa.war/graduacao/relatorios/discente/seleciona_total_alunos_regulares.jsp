...
<h2><ufrn:subSistema /> > Quantitativo de Discentes Regulares por Gênero e Status </h2>
	...
	<tfoot>
		<tr>
			<td colspan="3" align="center">
				<h:commandButton id="gerarRelatorio" value="Gerar Relatório" action="#{relatorioDiscente.totalAlunosRegulares}"/> 
