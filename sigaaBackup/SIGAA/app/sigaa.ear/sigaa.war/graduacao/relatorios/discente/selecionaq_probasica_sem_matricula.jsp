...
<h2><ufrn:subSistema /> > Quantitativos de Alunos de Probásica sem matrícula</h2>
...
<table align="center" class="formulario" width="100%">
	...
	<tr>
		<td colspan="2" align="center">
						<h:commandButton id="gerarRelatorio" value="Gerar Relatório" action="#{relatorioDiscente.gerarRelatorioQuantitativoAlunoProbasicaSemMatricula}">
