...
<h2><ufrn:subSistema /> > Relatório de Quantitativos de Alunos por Sexo e Egresso</h2>
...
<table align="center" class="formulario" width="100%">
	...
	<tr>
		<td colspan="2" align="center">
						...
						action="#{relatorioDiscente.gerarRelatorioQuantitativoAlunoSexoEgresso}"/> <h:commandButton
