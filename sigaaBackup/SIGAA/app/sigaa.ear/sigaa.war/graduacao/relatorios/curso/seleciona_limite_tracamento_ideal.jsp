...
<table align="center" class="formulario" width="100%">
	...
	<tr>
		<th>Centro: </th>
		<td><h:inputHidden id="idCentro" value="#{relatorioCurso.centro.id}"></h:inputHidden>
				<h:inputText id="nomeCentro"
					value="#{relatorioCurso.centro.nome}" size="80" /> <ajax:autocomplete
	...
	<tr>
		<th>Curso: </th>
		<td><h:inputHidden id="idCurso" value="#{relatorioCurso.curso.id}"></h:inputHidden>
				<h:inputText id="nomeCurso"
					value="#{relatorioCurso.curso.nome}" size="80" /> <ajax:autocomplete
	...
	<tr>
		<td colspan="2" align="center">
						...
						action="#{relatorioCurso.gerarRelatorioListaAlunoChDetalhada}"/> <h:commandButton
