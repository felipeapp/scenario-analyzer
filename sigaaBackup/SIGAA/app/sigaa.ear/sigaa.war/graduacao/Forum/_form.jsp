...
<ul>
	...
	<li>
		...
		<t:inputTextarea id="descricao" rows="2" value="#{forum.object.descricao}"/>
	</li>
	<li>
		<br>
		<label>Tipo: </label>
	...
	<li>
		...
		<t:selectOneMenu id="email" value="#{forum.notificar}" styleClass="noborder">
	...
	<li>
		...
		<t:selectOneMenu id="ativo" value="#{forum.object.ativo}" styleClass="noborder">
			<f:selectItem itemLabel="Sim" itemValue="true"/>
			<f:selectItem itemLabel="Não" itemValue="false"/>
		</t:selectOneMenu>
