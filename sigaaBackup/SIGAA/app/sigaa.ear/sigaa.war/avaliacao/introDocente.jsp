...
<div class="intro-aval">
	...
	<div class="textos">
		...
		<p class="texto">Para efetivar a consolidação de sua turma é importante que a avalie. A sua avaliação é utilizada pela Reitoria para definir as ações de melhorias da Universidade.</p>
		...
		<%-- <p class="texto" style="margin: 20px 0;"><a href="http://ufrn.br/ufrn2/avaliacao/files/documentos/avaliacaodocencia200810.ppt">Clique aqui para ver o resultado da avaliação de 2008.1 e conheça mais um pouco sobre a nossa Instituição</a>.</p>--%>
