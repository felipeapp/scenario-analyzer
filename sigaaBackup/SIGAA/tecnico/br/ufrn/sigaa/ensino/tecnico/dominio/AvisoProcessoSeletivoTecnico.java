 ...
 */
@Entity
@Table(name = "aviso_tecnico", schema = "tecnico", uniqueConstraints = {})
public class AvisoProcessoSeletivoTecnico implements PersistDB, Validatable {
	...
	/** Construtor padrão. */
	public AvisoProcessoSeletivoTecnico() {
