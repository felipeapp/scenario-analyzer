 ...
 *
 */
public class ProcessadorCadastramentoDiscenteTecnico extends AbstractProcessador {
	...
	public Object execute(Movimento mov) throws NegocioException, ArqException,
		...
		if (mov.getCodMovimento().equals(SigaaListaComando.CONFIRMAR_CADASTRAMENTO_TECNICO)){
			
			CadastramentoDiscenteTecnicoDao dao = getDAO(CadastramentoDiscenteTecnicoDao.class, mov);
			int novoStatus = StatusDiscente.CADASTRADO;
			...
			try {
				...
				if (m.isDiscentesImportados()) {
					...
					for(CancelamentoConvocacaoTecnico c: m.getCancelamentos()) {
						if(c.getMotivo().equals(MotivoCancelamentoConvocacaoTecnico.REGRA_REGULAMENTO)) {
	...
	public void validate(Movimento mov) throws NegocioException, ArqException {
		...
		for(CancelamentoConvocacaoTecnico c: m.getCancelamentos()){
			...
			if(c.getMotivo().equals(MotivoCancelamentoConvocacaoTecnico.REGRA_REGULAMENTO) && c.getConvocacao().getDiscente().getStatus() != StatusDiscente.CANCELADO && c.getConvocacao().getDiscente().getStatus() != StatusDiscente.EXCLUIDO)
