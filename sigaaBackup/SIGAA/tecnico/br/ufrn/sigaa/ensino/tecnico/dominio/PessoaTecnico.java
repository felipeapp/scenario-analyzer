 ...
 */
@Entity
@Table(name = "pessoa_tecnico", schema = "tecnico")
public class PessoaTecnico extends PessoaGeral implements PersistDB, Validatable, Serializable {
	...
	private PessoaTecnico dadosAnteriores;
	...
	/** Construtor padrão. */
	public PessoaTecnico() {
		prepararDados();
	}

	/** Construtor parametrizado. */
	public PessoaTecnico(int id) {
		this();
		this.id = id;
	}

	/** Construtor parametrizado. */
	public PessoaTecnico(int idPessoa, String nome) {
		this(idPessoa);
		this.nome = nome;
	}

	/** Construtor parametrizado. */
	public PessoaTecnico(int idPessoa, String nome, long num) {
		this(idPessoa, nome);
		setCpf_cnpj(num);
	}
	...
	@GenericGenerator(name="seqGenerator", strategy="br.ufrn.arq.dao.SequenceStyleGenerator",
	           parameters={ @Parameter(name="sequence_name", value="tecnico.pessoa_seq") })
	...
	public PessoaTecnico getDadosAnteriores() {
		return dadosAnteriores;
	}

	public void setDadosAnteriores(PessoaTecnico dadosAnteriores) {
